    ...
    <?php $__env->stopSection(); ?>
        ...
        <script>
            function saveInput(){
                ...
                makeRequest("/admin/save-setting",{data: data,type: 'refund'}).then((e)=>{
                    console.log(e)
                    if(e.success){
        ...
        <?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.dashboard.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bloomzon/bloomzon/resources/views/dashboard/admin/refundpolicy.blade.php ENDPATH**/ ?>