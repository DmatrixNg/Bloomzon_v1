                ...
                <div class="col-md-4 p-5">
                    <div class="card p-0">
                        ...
                        <div class="col-md-12 text-center mt-3">
                            ...
                            <p><b>Amount:</b>&nbsp;&nbsp;&nbsp; <?php if($advert->payment_method == 'paypal'): ?> $ <?php else: ?> ₦ <?php endif; ?> <?php echo e($advert->amount); ?></p>
                            <p><b>Status:</b>&nbsp;&nbsp;&nbsp; <?php echo e($advert->status == null ? 'Inactive':$advert->status); ?></p>
    ...
    <script>
        async function deleteAd(el, id) {
            return swal({
                ...
                if (val) {
                    makeRequest('/fast_food_grocery/delete-ads/' + id).then((e)=>{
        ...
        async function changeStatus(el, id) {
            ...
            return swal({
                ...
                if (val) {
                    makeRequest('/fast_food_grocery/change-ads-status/'+id,{status:el}).then((e)=>{
...
<?php echo $__env->make('layouts.dashboard.fast_food_grocery', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bloomzon/bloomzon/resources/views/dashboard/fast_food_grocery/all-ads.blade.php ENDPATH**/ ?>