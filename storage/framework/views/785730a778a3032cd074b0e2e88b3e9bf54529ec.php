        ...
        <div class="slider-area">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-xl-4 pl-1" style="height: 40px;">
                        <div class="main-slider mt-30 mt-sm-0">
                            <?php $__currentLoopData = $adverts->where('advert_position', 'body'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $advert): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="slider-single" style="background-image: url('<?php echo e(asset("storage/ads/" . $advert->avatar)); ?>')">
                                    <div class="d-table">
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-10">
                        <div class="brand-items">
                            <div class="brand-item">
                                <a href="#">
                                    <img class="brand-static" src="<?php echo e(asset('front_assets/assets/img/i1.png')); ?>" height="50" alt="" />
                                </a>
                            </div>
                            <div class="brand-item">
                                <a href="#">
                                    <img class="brand-static" src="<?php echo e(asset('front_assets/assets/img/i2.png')); ?>" height="50" alt="" />
                                </a>
                            </div>
                            <div class="brand-item">
                                <a href="#">
                                    <img class="brand-static" src="<?php echo e(asset('front_assets/assets/img/i3.png')); ?>" height="50" alt="" />
                                </a>
                            </div>
                            <div class="brand-item">
                                <a href="#">
                                    <img class="brand-static" src="<?php echo e(asset('front_assets/assets/img/i4.png')); ?>" height="50" alt="" />
                                </a>
                            </div>
                            <div class="brand-item">
                                <a href="#">
                                    <img class="brand-static" src="<?php echo e(asset('front_assets/assets/img/i5.png')); ?>" height="50" alt="" />
                                </a>
                            </div>
                            <div class="brand-item">
                                <a href="#">
                                    <img class="brand-static" src="<?php echo e(asset('front_assets/assets/img/i6.png')); ?>" height="50" alt="" />
                                </a>
                            </div>
                            <div class="brand-item">
                                <a href="#">
                                    <img class="brand-static" src="<?php echo e(asset('front_assets/assets/img/dolce.png')); ?>" height="50" alt="" />
                                </a>
                            </div>
                            <div class="brand-item">
                                <a href="#">
                                    <img class="brand-static" src="<?php echo e(asset('front_assets/assets/img/tommy.png')); ?>" height="50" alt="" />
                                </a>
                            </div>
                            <div class="brand-item">
                                <a href="#">
                                    <img class="brand-static" src="<?php echo e(asset('front_assets/assets/img/dior.png')); ?>" height="50" alt="" />
                                </a>
                            </div>
                            <div class="brand-item">
                                <a href="#">
                                    <img class="brand-static" src="<?php echo e(asset('front_assets/assets/img/off.png')); ?>" height="50" alt="" />
                                </a>
                            </div>
                        </div>
                    </div>
                                                    ...
                                                    <div class="product-single">
                                                        <div class="product-thumb">
                                                            ...
                                                            <a href="#">
                                                                ...
                                                                <img src="<?php echo e(asset('storage/product/'.$product->avatars[0] ?? '')); ?>" alt="">
                                                                <?php endif; ?>
                                                            </a>
                                                ...
                                                <?php $__currentLoopData = $manufacturers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $manufacturer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    ...
                                                    <div class="col-lg-4 p-1 slick-slide slick-current slick-active"
                                                        ...
                                                        <div class="single-product-cat">
                                                            <a href="/manufacturer-details?manufacturer=<?php echo e(base64_encode(json_encode($manufacturer))); ?>"
                                                                tabindex="0"><img
                                                                    src="<?php echo e(asset($manufacturer->factory_image_url ?? '')); ?>"
                                                                    alt="" height="180"></a>
                                                            <h4><a href="/manufacturer-details?manufacturer=<?php echo e(base64_encode(json_encode($manufacturer))); ?>"
                                    ...
                                    <?php $__currentLoopData = $groceries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $grocery): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="product-single p-0"
                                            ...
                                            <div class="product-title text-white pull-right"
                                                ...
                                                <h4><a href="#"
                                                        style="color: #fff !important;"><?php echo e($grocery->company_name); ?></a>
                                                </h4>
                                            </div>
                                        </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <?php $__currentLoopData = $food_menus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $food_menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="col-lg-2 offset-2">
                                        <div class="product-single p-0"
                                            ...
                                            <div class="product-title text-white pull-right"
                                                style="background-color: #bd1a09; padding: 10px; bottom: 0; right: 0; position: absolute; margin-bottom: -20px; ">
                                                <h4><a href="#" style="color: #fff !important;"><?php echo e($food_menu->type); ?></a>
                                                </h4>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="row mt-40">
                    <div class="col-md-12" style="border-right: 1px solid #eee;">
                        <div class="best-sellers">
                            ...
                            <div class="row cv-visible">
                                <div class="col-lg-2">
                                    <div class="product-single p-0" style="background-image: url('<?php echo e(asset("front_assets/assets/img/food1.jpg")); ?>'); height: 220px; border-radius: 15px; background-size: cover; width: 100%;  background-repeat: no-repeat; background-position: center;">
                                        <div class="product-title pt-2" style=" width: 100%; background-color: #23374D; opacity: 0.8; position: absolute; bottom: 0; text-align: center; border-bottom-right-radius: 15px; border-bottom-left-radius: 15px;">
                                            <h4><a href="#" class="text-white">Fast Food Vendors</a></h4>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-2">
                                    <div class="product-single p-0" style="background-image: url('<?php echo e(asset("front_assets/assets/img/g2.jpg")); ?>'); height: 220px; border-radius: 15px; background-size: cover; background-position: center;">
                                        <div class="product-title pt-2" style=" width: 100%; background-color: #23374D; opacity: 0.8; position: absolute; bottom: 0; text-align: center; border-bottom-right-radius: 15px; border-bottom-left-radius: 15px;">
                                            <h4><a href="#" class="text-white">Groceries</a></h4>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-2">
                                    <div class="product-single p-0" style="background-image: url('<?php echo e(asset("front_assets/assets/img/b3.jpg")); ?>'); height: 220px; border-radius: 15px; background-size: cover; background-position: center;">
                                        <div class="product-title pt-2" style=" width: 100%; background-color: #23374D; opacity: 0.8; position: absolute; bottom: 0; text-align: center; border-bottom-right-radius: 15px; border-bottom-left-radius: 15px;">
                                            <h4><a href="<?php echo e(url('networking-agents')); ?>" class="text-white">Networking Associates</a></h4>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-2">
                                    <div class="product-single p-0" style="background-image: url('<?php echo e(asset("front_assets/assets/img/b1.jpeg")); ?>'); height: 220px; border-radius: 15px; background-size: cover; background-position: center;">
                                        <div class="product-title pt-2" style=" width: 100%; background-color: #23374D; opacity: 0.8; position: absolute; bottom: 0; text-align: center; border-bottom-right-radius: 15px; border-bottom-left-radius: 15px;">
                                            <h4><a href="#" class="text-white">Manufacturers</a></h4>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-2">
                                    <div class="product-single p-0" style="background-image: url('<?php echo e(asset("front_assets/assets/img/p1.jpg")); ?>'); height: 220px; border-radius: 15px; background-size: cover; background-position: center;">
                                        <div class="product-title pt-2" style=" width: 100%; background-color: #23374D; opacity: 0.8; position: absolute; bottom: 0; text-align: center; border-bottom-right-radius: 15px; border-bottom-left-radius: 15px;">
                                            <h4><a href="#" class="text-white">Professional Services</a></h4>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-2">
                                    <div class="product-single p-0" style="background-image: url('<?php echo e(asset("front_assets/assets/img/p2.jpg")); ?>'); height: 220px; border-radius: 15px; background-size: cover; background-position: center;">
                                        <div class="product-title pt-2" style=" width: 100%; background-color: #23374D; opacity: 0.8; position: absolute; bottom: 0; text-align: center; border-bottom-right-radius: 15px; border-bottom-left-radius: 15px;">
                                            <h4><a href="#" class="text-white">Sellers</a></h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-4 col-lg-6">
                            <div class="banner-sm hover-effect">
                                <a href="<?php echo e($advert->advert_link); ?>">
                                    <img src="<?php echo e(asset($advert->advert_image_url1)); ?>" height="270" width="100%" alt="">
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\bloomzoon_app\resources\views/front/index.blade.php ENDPATH**/ ?>