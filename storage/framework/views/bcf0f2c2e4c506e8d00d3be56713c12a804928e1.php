    ...
    <div class="col-md-10">
        ...
        <div class="container">
            <div class="float-left">
                <a href="<?php echo e(url('/')); ?>" style="background-color: #BA220E; color:white; width: 150px; border-radius: 20px; padding:10px;">SITE</a>
            </div>
        </div>
    </div>
<?php $__env->stopSection(); ?>
...
<?php echo $__env->make('layouts.dashboard.networking_agent', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/bloomzoon_app/resources/views/dashboard/networking_agent/histogram.blade.php ENDPATH**/ ?>