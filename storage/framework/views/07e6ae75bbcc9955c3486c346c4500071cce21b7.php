...
<?php $__env->stopSection(); ?>
            ...
            <div class="col-md-12 text-center">
             ...
             <div class="row mb-5" style="background-color: white; height: 450px;  padding: 50px;">
                <div class="col-md-10 offset-1 text-center">
                    <textarea class="form-control mb-5" id="pp" rows="40"><?php echo e(\App\SiteConfig::find(1)->terms); ?></textarea>
    ...
    <?php $__env->stopSection(); ?>
        ...
        <?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.dashboard.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Bloomzon_v1\resources\views/dashboard/admin/terms.blade.php ENDPATH**/ ?>