                ...
                <div class="row">
                    <div class="col-lg-1 col-md-2">
                        <ul class="nav nav-tabs products-nav-tabs">
                            ...
                            <li><a data-toggle="tab" href="#product-<?php echo e($key); ?>"><img src="<?php echo e(asset('storage/product/'.$image)); ?>" alt=""></a></li>
                        ...
                        <div class="tab-content">
                            ...
                            <div id="product-<?php echo e($key); ?>" class="tab-pane fade in show <?php if($key == 0): ?>active <?php endif; ?>">
                                <div class="product-details-thumb">
                                    <a class="venobox vbox-item" data-gall="myGallery" href="<?php echo e(asset('storage/product/'.$image)); ?>"><i class="fa fa-search-plus"></i></a>
                                ...
                                <ul class="list-none">
                                    ...
                                    <li>
                                        ...
                                        <div class="comment-avatar text-center">
                                            <img src="<?php echo e($review->buyer_id->avatar); ?>" alt="" height="50" width="50" h>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\bloomzoon_app\resources\views/front/product-details.blade.php ENDPATH**/ ?>