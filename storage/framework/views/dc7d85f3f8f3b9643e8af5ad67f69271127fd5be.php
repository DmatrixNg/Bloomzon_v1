            ...
            <div class="row mb-3 " style=" padding: 100px; ">
                <div class="col-md-6 p-5 offset-3">
                    ...
                    <form name="updateProfile" id="updateProfile">
                        ...
                        <img src="<?php echo e(asset('storage/assets/buyer/avatar/'.$buyer->avatar)); ?>" class="img img-circle"  width="100 " height="100 ">
                        </div>
                        ...
                        <input type="email" disabled class="form-control "  value="<?php echo e($buyer->email); ?>"  name="email" id="email " placeholder="Olivia@gmail.com " style="height: 40px; ">
                        </div>
                        <div class="form-group ">
...
<?php echo $__env->make('layouts.dashboard.buyer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/DMatrix/work/new/Bloomzon_v1/resources/views/dashboard/buyer/edit-profile.blade.php ENDPATH**/ ?>