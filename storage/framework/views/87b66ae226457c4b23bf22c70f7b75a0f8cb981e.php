        ...
        <div class="row mb-3" style="background-color: #fff !important; padding: 20px;">
            <div class="col-md-8 p-5 offset-2">
                ...
                <form name="addProductForm">
                    ...
                    <input type="text" name="product_name" value="<?php echo e($product->product_name); ?>" class="form-control" id="product_name"
                    ...
                    <textarea name="product_description" id="product_description" cols="30" rows="10"
                            class="form-control" style="border-radius: 0;" placeholder=""><?php echo e($product->product_description); ?>
                    ...
                    <input type="text" name="product_price" value="<?php echo e($product->product_price); ?>" class="form-control" id="product_price" placeholder=""
                            style=" height: 40px; border-radius: 0; ">
                    </div>
                    <div class="form-inline">
                        <label class="mr-5" for="product_sales_price"  style="font-size: 16px;">Actual Amount: </label>
                    <input type="text" name="product_sales_price" value="<?php echo e($product->product_sales_price); ?>" class="form-control mt-4" id="product_price" placeholder=""
                            style=" height: 40px; border-radius: 0; ">
                    </div>
...
<?php $__env->startPush('scripts'); ?>
    <script>
        ...
        FormHandler('addProductForm', {
            requestUrl: '/professional/product/edit/<?php echo e($product->id); ?>',
            requestType: 'POST',
            props: {
                imgs: sto,//
                colors: colors
...
<?php echo $__env->make('layouts.dashboard.professional', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/bloomzoon_app/resources/views/dashboard/professional/edit-product.blade.php ENDPATH**/ ?>