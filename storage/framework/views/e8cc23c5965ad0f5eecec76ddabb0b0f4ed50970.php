    ...
    <div class="col-md-10">
        <div class="row" style="padding: 40px;">
            <div class="col-md-8 offset-2 text-center mt-2 mb-5">
                <img src="<?php echo e(asset('storage/assets/seller/avatar/' . $seller->avatar)); ?>" height="140" width="140"
...
<?php echo $__env->make('layouts.dashboard.seller', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/DMatrix/work/sqt/bloom/resources/views/dashboard/seller/edit-profile.blade.php ENDPATH**/ ?>