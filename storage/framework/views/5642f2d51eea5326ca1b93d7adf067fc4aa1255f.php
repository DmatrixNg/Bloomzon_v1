			...
			<div class="row">
				...
				<div class="card">
					<div class="card-body">
					  ...
					  <a href="<?php echo e(url('fast_food_grocery/login')); ?>" class="btn btn-primary">Login</a>
					</div>
				  </div>
				</div>
				<div class="col-lg-4 text-center mb-2">
				<div class="card">
					<div class="card-body">
					  ...
					  <a href="<?php echo e(url('nmanufacturer/login')); ?>" class="btn btn-primary">Login</a>
					</div>
				  </div>
				</div>
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/bloomzon/resources/views/auth/login.blade.php ENDPATH**/ ?>