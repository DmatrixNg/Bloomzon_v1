                            ...
                            <div class="col-lg-4 col-md-5">
                                <div class="product-action stuck text-left">
                                    ...
                                    <div class="product-colors mt-20">
                                        ...
                                        <input type="text" class="form-control" readonly id="colored" name="color" value="">
...
<script>
    var element = document.getElementById('cart');
        element.onclick = async e => {
            ...
            var color = document.getElementById(`colored`).value ;
            try{
              if (color) {
              ...
              var  color ="null"
                ...
                console.log(  color)
                const response = await (await fetch(`/cart/add/${productId}/${quantity}/${color}`, {
                method: 'GET',
                headers: {
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Bloomzon_v1\resources\views/front/product-details.blade.php ENDPATH**/ ?>