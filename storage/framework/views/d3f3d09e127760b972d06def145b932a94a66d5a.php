        ...
        <div class="col-md-4">
            <a href="wallet">
                <div class="card text-center" style="color: #02499B; background-color: white; padding: 30px;">
                    ...
                    <h1><b><?php echo e(count($withdrawals)); ?></b></h1>
                </div>
            </a>
        </div>
        <div class="col-md-4">
            <a href="orders">
                <div class="card text-center" style="color: #02499B; background-color: white; padding: 30px;">
                    ...
                    <h1><b><?php echo e(count($orders)); ?></b></h1>
                </div>
            </a>
        </div>
        <div class="col-md-4">
            <div class="card text-center pr-0" style="color: #02499B; background-color: white;">
                <img src="<?php echo e(asset('assets/frontend/img/medium-fb-ad.png')); ?>">
            </div>
        </div>
    </div>
    <br>
                ...
                <div class="row col-md-6 mr-2 mb-3">
                    <div
                        ...
                        <div class="col-md-4 m-auto">
                            ...
                            <img src="<?php echo e(asset('storage/assets/product/avatars/' .  $product->avatars[0])); ?>" height="120" width="170"
...
<?php echo $__env->make('layouts.dashboard.professional', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bloomzon/bloomzon/resources/views/dashboard/professional/home.blade.php ENDPATH**/ ?>