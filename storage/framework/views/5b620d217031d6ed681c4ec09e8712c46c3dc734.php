                ...
                <div class="row mb-3" style="background-color: #fff !important; padding: 20px;">
                    <div class="col-md-8 p-5 offset-2">
                        <form name="issueForm">
                            ...
                            <input type="hidden" value="<?php echo e($user->id); ?>" name="buyer_id">
                            <div class="form-group">
...
<?php echo $__env->make('layouts.dashboard.buyer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\bloomzoon_app\resources\views/dashboard/buyer/contact-admin.blade.php ENDPATH**/ ?>