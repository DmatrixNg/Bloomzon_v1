...
<?php $__env->startSection('content'); ?>
        <div class="col-md-10">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <a href="<?php echo e(route('admin.edit-product',$product->id)); ?>" target="_blank" class="btn" style="background-color: #AF2E1D; border-radius: 5px; width: 130px; color: white; margin-top:2px">Edit</a>
        ...
        async function deleteProd(el, id) {
            return swal({
                ...
                (val) => {
                    if (val) {
                        makeRequest('/admin/product/delete/' + id).then(
                            (res) => {
                                console.log(res)
                                if(res.success){
...
<?php echo $__env->make('layouts.dashboard.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bloomzon/bloomzon/resources/views/dashboard/admin/bloomzonproduct.blade.php ENDPATH**/ ?>