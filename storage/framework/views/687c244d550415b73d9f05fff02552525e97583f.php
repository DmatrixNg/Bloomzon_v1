                ...
                <form name="accountDetailsForm" id="accountDetailsForm">
                    ...
                    <div class="form-group">
                        <div class="">
                            ...
                            <input type="text" value="<?php echo e(substr($networking_agent->card_number,0,4)); ?>***********" name="card_number" id="card_number" class="form-control"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" value="<?php echo e($networking_agent->bank_name); ?>" disabled class="form-control" placeholder="No bank selected">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text"  value="<?php echo e($networking_agent->card_expires); ?>" name="card_expires" id="card_expires" class="form-control" placeholder="02/23">
                        </div>

                        <div class="col-md-6 pl-0">
                            <label for="cvv" style="font-size: 16px;;"> cvv: </label>
                            <input type="password" value="<?php echo e($networking_agent->cvv); ?>" name="cvv" id="cvv" class="form-control" placeholder="****">
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.dashboard.networking_agent', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\bloomzoon_app\resources\views/dashboard/networking_agent/accountdetails.blade.php ENDPATH**/ ?>