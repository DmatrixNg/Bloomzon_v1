        ...
        <div class="slider-area">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-xl-4">
                        <div class="row mt-30">
                            <div id="bodyCar" class="carousel slide" data-ride="carousel">
                                <div class="carousel-inner">
                                    <?php ($count = 0); ?>
                        ...
                        <div class="best-sellers">
                            ...
                            <div class="row cv-visible">
                                <?php $__currentLoopData = $vendors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vendor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="col-lg-2">
                                        <div class="product-single p-0"
                                            style="background-image: url('assets/img/food1.jpg'); height: 220px; border-radius: 15px; background-size: contain; width: 100%;  background-repeat: no-repeat; background-position: center;">
                                            <div class="product-title pt-2"
                                                style=" width: 100%; background-color: #23374D; opacity: 0.8; position: absolute; bottom: 0; text-align: center; border-bottom-right-radius: 15px; border-bottom-left-radius: 15px;">
                                                <h4><a href="#" class="text-white"><?php echo e($vendor->name); ?></a></h4>
                                            </div>
                                        </div>
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
                            <div class="text-center pt-2"><a
                                    href="/vendors?vendors=<?php echo e(base64_encode(json_encode($vendors))); ?>"
                                    class="btn btn-danger text-white">MORE</a></div>
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/bloomzoon_app/resources/views/front/index.blade.php ENDPATH**/ ?>