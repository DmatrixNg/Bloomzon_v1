                ...
                <div class="row mb-3" style="background-color: #fff !important; padding: 20px;">
                    <div class="col-md-8 p-5 offset-2">
                        ...
                        <input name="ticket" value="<?php echo e($ticket); ?>"  type="hidden"/>
                            ...
                            <input type="hidden" value="<?php echo e($buyer->id); ?>" name="buyer_id">
                            <div class="form-group">
...
<?php echo $__env->make('layouts.dashboard.buyer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/bloomzoon_app/resources/views/dashboard/buyer/contact-admin.blade.php ENDPATH**/ ?>