<div class="col-md-2 pb-5">
    <div class="card p-0">
        ...
        <a href="<?php echo e(route('shopper.routing')); ?>"><i class="fas fa-route"></i> Control/Routing Check</a>
            ...
            <div class="dropdown-container">
                <a class="dropdown-item" href="<?php echo e(route('shopper.all-ads')); ?>"> All Ads</a>
                <a class="dropdown-item" href="<?php echo e(route('shopper.post-new-ads')); ?>"> Post New Ads</a>
            </div>
            <a href="<?php echo e(url('/shopper/messages')); ?>"><i class="fas fa-users-cog"></i> Contact Admin</a>
            <a href="<?php echo e(url('shopper/reviews-and-feedback')); ?>"><i class="fas fa-comment-alt"></i> Customers Feedback</a>
            <a href="<?php echo e(url('/shopper/settings')); ?>"><i class="fa fa-cog"></i> Settings</a>
            <a href="<?php echo e(url('#')); ?>"><i class="fa fa-envelope"></i> Messages</a>
...
</div><?php /**PATH /home/bloomzon/bloomzon/resources/views/components/dashboard/shopper-side-nav.blade.php ENDPATH**/ ?>