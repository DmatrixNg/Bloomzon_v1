                      ...
                      <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col-md-4 p-3 mb-4">
                                <div class="card p-0" style="box-shadow: 0 4px 8px 0 rgba(0,0,0,0.1); border-radius: 0px !important;">
                                    ...
                                    <div class="row p-2">
                                        <div class="col-md-3"> 
                                            <img src="<?php echo e(asset('storage/assets/product/avatars/'.$order->product->avatars[0])); ?>" class="img" width="60" alt="">
                                        ...
                                        <div class="col-md-7">
                                            ...
                                            <div class="badge pull-right text-white" style=" background-color: green;"><?php echo e($order->shopper_status); ?></div>
                                        </div>
...
<?php echo $__env->make('layouts.dashboard.shopper', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/bloomzoon_app/resources/views/dashboard/shopper/delivery-request.blade.php ENDPATH**/ ?>