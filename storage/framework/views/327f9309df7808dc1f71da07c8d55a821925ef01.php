            ...
            cb: response => {
                if(response.success){
                    return swal({
                        ...
                        window.location.href = '/seller/all-coupons'
                    })
                }
...
<?php echo $__env->make('layouts.dashboard.seller', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bloomzon/bloomzon/resources/views/dashboard/seller/promotion2.blade.php ENDPATH**/ ?>