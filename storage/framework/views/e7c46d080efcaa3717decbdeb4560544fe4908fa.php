                ...
                <div class="col-md-6 order-2 order-lg-3">
                    <div class="widgets-wrap d-flex justify-content-end">
                        ...
                        <div class="widget-header ml-3 text-center">
                            <a href="#">
                                <img src="asset/img/intercontinental.png" class="img img-circle m-auto" width="80" height="80">
                                <p class="text-center">Dangote Kitchen</p>
                            </a>
                        </div>
                    </div>
                    <!-- widgets-wrap.// -->
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/bloomzoon_app/resources/views/components/dashboard/fast-food-grocery-header.blade.php ENDPATH**/ ?>