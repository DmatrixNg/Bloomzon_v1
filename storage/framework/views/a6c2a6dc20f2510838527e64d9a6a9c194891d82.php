                ...
                <form name="accountDetailsForm" id="accountDetailsForm">
                    ...
                    <div class="form-group">
                        <div class="form-group">
                            ...
                            <input type="text" value="<?php echo e($seller->account_name); ?>" id="account_name" name="account_name"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 pr-0">
                            ...
                            <input type="text" value="<?php echo e($seller->bank_name); ?>" disabled class="form-control"
                                placeholder="No bank selected">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="exampleFormControlInput1" style="font-size: 16px;;">Account Number: </label>
                        <input type="text" class="form-control" name="account_number" value="<?php echo e($seller->account_number); ?>"
...
<?php echo $__env->make('layouts.dashboard.seller', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/DMatrix/work/sqt/bloom/resources/views/dashboard/seller/account-details.blade.php ENDPATH**/ ?>