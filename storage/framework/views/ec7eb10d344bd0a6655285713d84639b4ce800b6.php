              ...
              <tbody>
               <?php if(count($shoppers)): ?>
                ...
                <tr>
                  ...
                  <td> <a href="<?php echo e(url('/admin/shopper-details', $shopper->id)); ?>" target="_blank"><?php echo e($shopper->full_name); ?></a></td>
                  <td><?php echo e($shopper->email); ?></td>
                <td><?php echo e($shopper->phone_number); ?></td>
                <td><?php echo e($shopper->account_type); ?></td>
                <td><?php echo e($shopper->subscription_date); ?></td>
                <td><?php echo e($shopper->state); ?></td>
                <td><?php echo e($shopper->street_address); ?></td>
                <td>
                  <?php if($shopper->account_status == 'active'): ?>
                      <button class="btn btn-sm bg-success text-white" onclick="change_status(<?php echo e($shopper->id); ?>)">Active</button>
                    <?php else: ?>
                      <button class="btn btn-sm bg-primary text-white" onclick="change_status(<?php echo e($shopper->id); ?>)">Inactive</button>
                    <?php endif; ?>
                </td>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.dashboard.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Bloomzon_v1\resources\views/dashboard/admin/all_shoppers.blade.php ENDPATH**/ ?>