        ...
        <div class="card p-0">
            ...
            <div class="row col-md-12 p-3 " style="padding: 20px;">
                <div class="col-md-4 p-3 ml-5" style=" border-bottom: 1px solid #f2f2f2;">
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6 text-left "><img
                                src="<?php echo e(asset('storage/assets/buyer/avatar/' . $review->buyer_id->avatar)); ?>"
                                class="img img-circle" width="50" height="50"> <b><?php echo e($review->buyer_id->full_name); ?></b>
                        </div>
                        <div class="col-md-6 text-right "><?php echo e(date('Y-m-d', strtotime($review->created_at))); ?></div>
                    </div>
                ...
                <?php $__currentLoopData = $review->replies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reply): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($reply->reply_by->id == $seller->id && $reply->reply_type == 'seller'): ?>
                    <div class="row col-md-12 p-3 " style="padding: 20px;">
                    <div class="col-md-4 offset-8" style=" border-bottom: 1px solid #f2f2f2;">
                        <div class="row mb-3">
                            <div class="col-md-6 text-left "><img
                                    src="<?php echo e(asset('storage/assets/' . $reply->reply_type . '/avatar/' . $reply->reply_by->avatar)); ?>"
                                    class="img img-circle" width="50" height="50">
                                <b><?php echo e($reply->reply_by->full_name); ?></b></div>
                            <div class="col-md-6 text-right "><?php echo e(date('Y-m-d', strtotime($reply->created_at))); ?></div>
                        </div>
            ...
            <div class="row col-md-12 text-center ml-1"
                ...
                <div class="form-inl  col-8 m-auto">
                    <form name="replyMsg">
                        ...
                        <input name="reply_by" value="<?php echo e(Auth::guard('seller')->user()->id); ?>" type="hidden" />
                        <input name="reply_type" value="seller" type="hidden" />
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script>
        FormHandler('replyMsg', {
            requestUrl: '/seller/reply-review',
            requestType: 'POST',
...
<?php echo $__env->make('layouts.dashboard.seller', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bloomzon/bloomzon/resources/views/dashboard/seller/reply-review.blade.php ENDPATH**/ ?>