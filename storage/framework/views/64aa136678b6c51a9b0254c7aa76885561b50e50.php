				...
				<div class="col-lg-6 offset-3 text-center">
					...
					<div class="product-single">
						<div class="contact-form mt-sm-30">
							<h4>Fast Food/Grocery Login Form</h4>
							<form method="post" name="loginForm" data-toggle="validator">
                                <?php echo csrf_field(); ?>
								<div class="row">
									<ul id="error_list"></ul>
...
unset($__errorArgs, $__bag); ?>" name="password" placeholder="Password">
									...
									<hr>
									<div class="col-sm-12 text-center pt-30">Don't have an account yet? <a href="<?php echo e(url('fast_food_grocery/register')); ?>">Create account</a></div>
...
<script>
    ...
    FormHandler('loginForm', {
        requestUrl: '/fast_food_grocery/login',
            cb: response => {
                if (response.success) {
                        window.location.href = '/fast_food_grocery/dashboard'
                }
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/bloomzoon_app/resources/views/front/auth/fast_food_grocery/login.blade.php ENDPATH**/ ?>