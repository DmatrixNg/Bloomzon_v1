                ...
                <div class="col-md-4 p-5">
                    <a href="#">
                        <div class="card align-items-center" style="padding: 20px; border-radius: 20px; height: 150px;">
                            ...
                            <h4 style="color: #BA220E;"><?php echo e($withdrawals->sum('amount')); ?> </h4>
                ...
                <div class="col-md-4 p-5">
                    <a href="#">
                        <div class="card align-items-center" style="padding: 20px; border-radius: 20px; height: 150px;">
                            ...
                            <h4 style="color: #BA220E;"><?php echo e(count($orders->where('status','moved_to_warehouse'))); ?> </h4>
...
<?php echo $__env->make('layouts.dashboard.seller', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/DMatrix/work/new/Bloomzon_v1/resources/views/dashboard/seller/home.blade.php ENDPATH**/ ?>