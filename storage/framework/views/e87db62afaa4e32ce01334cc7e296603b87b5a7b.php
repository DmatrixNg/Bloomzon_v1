            ...
            <div class="panel-group text-center mt-5 mb-5" id="accordion">
                <div class="panel panel-default">
                    <div class="panel-heading p-5">
                        <a style="color: #02499B;" href="<?php echo e(url('/manufacturer/login')); ?>">
...
<?php echo $__env->make('layouts.dashboard.seller', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/DMatrix/work/sqt/bloom/resources/views/dashboard/seller/settings.blade.php ENDPATH**/ ?>