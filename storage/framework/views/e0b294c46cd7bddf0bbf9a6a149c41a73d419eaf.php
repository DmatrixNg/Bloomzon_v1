            ...
            <div class="col-md-6 p-5 offset-3">
                <form name="accountDetailsForm" id="accountDetailsForm">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" value="<?php echo e($buyer->account_name); ?>" id="account_name" name="account_name" class="form-control" placeholder="">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" value="<?php echo e($buyer->bank_name); ?>" disabled class="form-control" placeholder="No bank selected">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="exampleFormControlInput1" style="font-size: 16px;;">Account Number: </label>
                    <input type="text" class="form-control" name="account_number" value="<?php echo e($buyer->acc_no); ?>" placeholder="0000000000">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" value="<?php echo e($buyer->cvv); ?>" name="cvv" id="cvv" class="form-control" placeholder="****">
                        </div>
                    </div>
...
<?php $__env->startPush('scripts'); ?>
    <script>
        ...
        FormHandler('accountDetailsForm', {
            requestUrl:'/buyer/edit-profile/<?php echo e(Auth::guard(`buyer`)->user()->id); ?>',
...
<?php echo $__env->make('layouts.dashboard.buyer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/bloomzoon_app/resources/views/dashboard/buyer/update-account-details.blade.php ENDPATH**/ ?>