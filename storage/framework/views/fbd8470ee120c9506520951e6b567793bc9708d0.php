 ...
 function removeItem(el) {
		...
		function applyCoupon(){
			...
			makeRequest('/cart/add-coupon',{code:coup}).then((e)=>{
				if(e.success){
					return swal("Your coupon has been added - proceed to checkout")
				}
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/bloomzon/resources/views/front/cart.blade.php ENDPATH**/ ?>