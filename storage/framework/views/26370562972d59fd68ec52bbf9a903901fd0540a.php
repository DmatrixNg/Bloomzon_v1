                            ...
                            <div class="row col-md-12 mb-2 ml-1" style="border-bottom: 1px solid #f2f2f2; padding: 20px;">
                                ...
                                <div class="row">
                                    <div class="col-md-7">
                                        ...
                                        <p><span style="font-weight: bold">Billing Address:</span> <?php echo e($purchase->order_details[0]->buyer_id->billing_address); ?></p>
                                ...
                                <a href="<?php echo e(route('buyer.delivery-status',$purchase->id)); ?>" style="border-radius: 25px;" type="button" class="btn btn-info btn-sm">Delivery Status</a>
                                </div>
...
<?php echo $__env->make('layouts.dashboard.buyer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/bloomzoon_app/resources/views/dashboard/buyer/purchase-history.blade.php ENDPATH**/ ?>