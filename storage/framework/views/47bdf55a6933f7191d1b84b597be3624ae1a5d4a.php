				...
				<div class="col-lg-6 offset-3 text-center">
					...
					<div class="product-single">
						<div class="contact-form mt-sm-30">
							<h4>Professional's Login Form</h4>
							<form method="post" action="<?php echo e(url('professional/login')); ?>" data-toggle="validator">
                                <?php echo csrf_field(); ?>
								<div class="row">
...
unset($__errorArgs, $__bag); ?>" name="password" placeholder="Password">
									...
									<hr>
									<div class="col-sm-12 text-center pt-30">Don't have an account yet? <a href="<?php echo e(url('professional/register')); ?>">Create account</a></div>
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/bloomzon/resources/views/front/auth/professional/login.blade.php ENDPATH**/ ?>