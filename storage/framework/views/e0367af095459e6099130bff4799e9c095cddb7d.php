...
<?php $__env->startSection('content'); ?>
    <div class="col-md-10">
        ...
        <a class="btn btn-sm btn-success" href="<?php echo e(route('fast_food_grocery.orders')); ?>">Go back</a>
   ...
   await makeRequest('/fast_food_grocery/change-order-status', {id:id,status:el.value}).then((e)=>{
...
<?php echo $__env->make('layouts.dashboard.fast_food_grocery', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bloomzon/bloomzon/resources/views/dashboard/fast_food_grocery/order-details.blade.php ENDPATH**/ ?>