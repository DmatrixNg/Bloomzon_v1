...
<?php $__env->stopSection(); ?>
                    ...
                    <div class="table-responsive">
                        <table id="histogram" class="display table" style="width: 100%; cellspacing: 0;">
                            ...
                            <tr>
                                ...
                                <td><a href="<?php echo e(route('professional.order-details',base64_encode(json_encode($order)))); ?>" style="background-color: #E5E5E5; color: black;" class="btn">Details</a></td>
                            </tr>
        ...
        <?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.dashboard.professional', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\bloomzon\resources\views/dashboard/professional/histogram.blade.php ENDPATH**/ ?>