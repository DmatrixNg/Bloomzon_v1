				...
				<div class="col-lg-6 offset-3 text-center">
					...
					<div class="product-single">
						<div class="contact-form mt-sm-30">
							...
							<form method="post" action="<?php echo e(url('manufacturer/login')); ?>" data-toggle="validator">
                                <?php echo csrf_field(); ?>
								<div class="row">
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/bloomzoon_app/resources/views/front/auth/manufacturer/login.blade.php ENDPATH**/ ?>