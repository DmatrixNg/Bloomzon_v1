                ...
                <form name="accountDetailsForm" id="accountDetailsForm">
                    ...
                    <div class="form-group">
                        <div class="form-group">
                            ...
                            <input type="text" value="<?php echo e($fast_food_grocery->account_name); ?>" id="account_name" name="account_name"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="account_number" value="<?php echo e($fast_food_grocery->account_number); ?>"
...
<?php $__env->startPush('scripts'); ?>
    <script>
        ...
        FormHandler('accountDetailsForm', {
            requestUrl: '/fast_food_grocery/edit-bank-account/<?php echo e(Auth::guard(`fast_food_grocery`)->user()->id); ?>',
...
<?php echo $__env->make('layouts.dashboard.fast_food_grocery', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bloomzon/bloomzon/resources/views/dashboard/fast_food_grocery/update-account-details.blade.php ENDPATH**/ ?>