                ...
                <div class="row col-md-12 mb-3" style="padding: 20px;">
                    ...
                    <div class="mb-2 p-4" style="border-radius: 20px; background-color: #fcfcfc; width: 100%; border: 1px solid #fcfcfc; text-shadow: #666;">
                        <a href="reply-review">
                            ...
                            <a href="<?php echo e(url('shopper/reply-review/'.$review->id)); ?>" class="btn btn-outline-primary mr-4" style="border: solid 1px #666;">Reply</button>
                            </div>
                        </a>
                    </div>
...
<?php echo $__env->make('layouts.dashboard.shopper', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bloomzon/bloomzon/resources/views/dashboard/shopper/review-feedback.blade.php ENDPATH**/ ?>