        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 offset-3 text-center">
                    ...
                    <form method="post" action="<?php echo e(url('professional/register')); ?>" class="contact-form mt-sm-30 col-md-12">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\bloomzoon_app\resources\views/front/auth/professional/register.blade.php ENDPATH**/ ?>