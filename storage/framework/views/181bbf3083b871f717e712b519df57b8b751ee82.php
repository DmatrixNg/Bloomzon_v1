            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-4 d-flex order-3">
                    <div class="row">
                        ...
                        <div class="col-md-6 m-0 p-0"><h5 class="m-0 p-2" style="color: #02499B;"><b>N20,000</b></h5></div>
                        <div class="col-md-6 m-0 p-0"><h5 class="m-0 p-2" style="color: #02499B;"><b>Net Balance</b></h5></div>
                        <div class="col-md-6 m-0 p-0"><h5 class="m-0 p-2" style="color: #02499B;"><b>N80,000</b></h5></div>
                    </div>
                </div>
                <!-- col.// -->
                    ...
                    <div class="widgets-wrap d-flex justify-content-end">
                        ...
                        <div class="widget-header ml-3 text-center">
                            <a href="#">
                                ...
                                <p class="text-center">Ose John</p>
                            </a>
                        </div>
                    </div>
                    <!-- widgets-wrap.// -->
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/bloomzoon_app/resources/views/components/dashboard/professional-header.blade.php ENDPATH**/ ?>