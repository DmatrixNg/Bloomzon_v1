        ...
        <div class="col-md-9">
            <div class="tab-content m-auto">
                <div id="grid-products" class="tab-pane active">
                        ...
                        <div class="row ">
                            ...
                            <div class="col-md-4 p-3 mb-4 mr-2">
                                <div class="card" style="width: 18rem;">
                                    ...
                                    <div class="card-body">
                                        <h5 class="card-title">Order ID:</span><span class="pl-5"><?php echo e($order->order_id); ?>
                                    ...
                                    <ul class="list-group list-group-flush">
                                        <li class="list-group-item">Seller:
                                            <?php echo e($order->seller_id->full_name); ?></li>
                                        <li class="list-group-item">Buyer:
                                            <?php echo e($order->orderable->full_name); ?></span></p>
                                        </li>
                                        <li class="list-group-item"><p><span style="font-weight: bolder">Billing
                                            Address:</span><?php echo e($order->orderable->billing_address); ?>
                    ...
                    <h4 class="alert alert-warning">No order found with the ID :  <?php echo e($id); ?></h4>
                     <?php else: ?>   
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Bloomzon_v1\resources\views/front/track-delivery.blade.php ENDPATH**/ ?>