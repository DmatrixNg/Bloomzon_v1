    ...
    <div class="col-md-10">
        ...
        <div class="row mb-3" style="background-color: #fff !important; padding: 20px;">
            <div class="col-md-8 p-5 offset-2">
                <form method="POST" action="<?php echo e(url('/buyer/store_message')); ?>">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.dashboard.buyer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/bloomzoon_app/resources/views/dashboard/buyer/message_create.blade.php ENDPATH**/ ?>