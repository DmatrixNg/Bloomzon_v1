            ...
            <div class="row">
                    ...
                    <div class="tab-content">
                        <div id="product-1" class="tab-pane fade in show active">
                            <div class="product-details-thumb">
                                ...
                                <img src="<?php echo e(asset('storage/assets/fast_food_grocery/avatar/'.$fast_food_grocery->avatar)); ?>" width="100%" height="450" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-5 mt-sm-50">
                    <div class="product-details-desc">
                        <h3><small>NAMES:</small> <span class="pl-5"><?php echo e($fast_food_grocery->shop_name); ?></span></h3>
                        <h3><small>REPRESENTATIVE NAME:</small> <span class="pl-5"><?php echo e($fast_food_grocery->full_name); ?></span></h3>
                        <h3><small>LOCATION: </small> <span class="pl-4"><?php echo e($fast_food_grocery->shop_address); ?></span></h3>
                        <h3><small>DESCRIPTION OF SERVICE: </small></h3>
                        <p><?php echo e($fast_food_grocery->service_description); ?>.</p>
                        <h3><small>CONTACT NUMBER: </small> <span class="pl-4"><?php echo e($fast_food_grocery->phone); ?></span></h3>
                        <h3><small>CONTACT EMAIL: </small> <span class="pl-5"><?php echo e($fast_food_grocery->email); ?></span></h3>
                        <h3><small>LAST SEEN: </small> <span class="pl-5"><?php echo e($fast_food_grocery->last_login); ?></span></h3>
        ...
        <div class="row">
            <div class="col-lg-12">
                <ul class="nav nav-tabs product-review-nav">
                    <li><a class="active" data-toggle="tab" href="#foodcata">Food Catalogue</a></li>
                    ...
                    <li><a data-toggle="tab" href="#availables">Availables</a></li>
                    <li><a data-toggle="tab" href="#reviews">Review (2)</a></li>
                </ul>
                <div class="tab-content">
                    <div id="foodcata" class="tab-pane fade in show active">
                        <div class="product-description">
                            <h2>Food Catalogue</h2>
                            <div class="products-tab mt-35">
                                <div class="row cv-visible">
                                    <?php if(count($food_cats)): ?>
                                    <?php $__currentLoopData = $food_cats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $food_menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="col-lg-2">
                    ...
                    <div id="termscond" class="tab-pane fade termscond">
                        <div class="product-description">
                            <h2>Terms &amp; Conditions</h2>
                            <p><?php echo e($fast_food_grocery->terms_and_conditions); ?></p>
                        </div>
                    </div>
                    <div id="deliverymet" class="tab-pane fade deliverymet">
                        <div class="product-description">
                            <h2>Delivery Method</h2>
                        <p><?php echo e($fast_food_grocery->delivery_terms); ?></p>
                        </div>
                    </div>
                        ...
                        <div class="best-sellers mt-45">
                            <div class="container-fluid fix">
                                <div class="row four-items cv-visible">
                                    <?php if(count($fast_food_grocery->products)): ?>
                                    <?php $__currentLoopData = $fast_food_grocery->products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="col-lg-3">
...
<?php endif; ?> 
                                ...
                                <div class="text-center"><a href="<?php echo e(url('/vendor-food-list/'.$fast_food_grocery->id)); ?>" class="btn btn-danger">View More</a></div>
                            </div>
                        </div>
                    </div>
                    <div id="reviews" class="tab-pane fade">
                        <div class="blog-comments product-comments mt-0">
                            <ul class="list-none">
                               <?php if(count($fast_food_grocery->reviews)): ?>
                                <?php $__currentLoopData = $fast_food_grocery->reviews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $review): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Bloomzon_v1\resources\views/front/fast-food-grocery-details.blade.php ENDPATH**/ ?>