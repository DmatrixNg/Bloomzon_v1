            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-3 d-flex order-3" style="padding-left: 80px !important;">
                    <div class="top-view" style="border-right: none !important;">
                        <h5 style="color: #02499B;"><b>Buyers ID: <?php echo e($buyer->id); ?></b></h5>
                    <h5 style="color: #02499B;"><b>Last Login: <?php echo e(date('Y-M-d H:m',strtotime($buyer->last_login))); ?></b></h5>
                    <h5 style="color: #02499B;"><b>Location: <?php echo e($buyer->street_address); ?></b></h5>
                    </div>
                </div>
                ...
                <div class="col-md-4 order-2 order-lg-3">
                    <div class="widgets-wrap d-flex justify-content-end">
                        ...
                        <div class="widget-header ml-3 text-center">
                            <a href="#">
                            <img src="<?php echo e(asset('storage/assets/buyer/avatar/'.$buyer->avatar)); ?>" class="img img-circle m-auto" width="100" height="100">
...
</div><?php /**PATH /Users/DMatrix/work/new/Bloomzon_v1/resources/views/components/dashboard/buyer-header.blade.php ENDPATH**/ ?>