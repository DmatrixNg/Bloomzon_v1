        ...
        <div class="col-md-10">
            ...
            <div class="row">
                <div class="col-md-8 offset-2" style="padding: 30px;">
                    <?php $__currentLoopData = $user_metas->Coupon; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $coupon): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="text-center align-items-center mt-4 mb-4" style="border-radius: 50px; padding: 30px;">
                            <div class="row">
                                ...
                                <div class="col-md-6 coupons">
                                    ...
                                    <?php else: ?>
                                        <p>Status: Active</p>
                                    <button class="btn" data-coupon-id="<?php echo e($coupon->id); ?>" style="color: white; background-color: #AF2E1D; border-radius: 20px;">Deactivate</button>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.dashboard.seller', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/bloomzoon_app/resources/views/dashboard/seller/promotion.blade.php ENDPATH**/ ?>