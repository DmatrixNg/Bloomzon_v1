<div class="col-md-2 pb-5">
    <div class="card p-0">
        <div class="sidenav p-0">
            ...
            <a href="<?php echo e(url('professional/request')); ?>"><i class="fas fa-comments"></i> Requests</a>
            <a href="<?php echo e(url('professional/sales-history')); ?>"><i class="fa fa-file"></i> Sales History</a>
            <a href="<?php echo e(url('wallet')); ?>"><i class="fas fa-wallet"></i> Wallet</a>
            <a href="<?php echo e(url('contact-admin')); ?>"><i class="fas fa-headset"></i> Contact Admin</a>
            <a href="<?php echo e(url('feedback-review')); ?>"><i class="fa fa-star"></i> Feedback & Review</a>
...
</div><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/bloomzoon_app/resources/views/components/dashboard/professional-side-nav.blade.php ENDPATH**/ ?>