...
<?php $__env->stopSection(); ?>
        ...
        <div class="col-md-10">
            ...
            <div style="background-color: white; padding: 30px;">
                <a href="<?php echo e(url('seller/edit-profile')); ?>">
                  <div class="row">
                      <div class="col-md-8 offset-2">
                          <div class="row">
                              <div class="col-md-3">
                                  <img class="img" src="<?php echo e(asset('storage/assets/seller/avatar/'.$seller->avatar)); ?>" width="80" height="80" style="border-radius: 40px" >
                              </div>
                              <div class="col-md-7">
                ...
                <hr>
                <a href="<?php echo e(url('seller/update-account-details')); ?>">
                    <div class="row">
                        <div class="col-md-8 offset-2">
                            <div class="row">
                                <div class="col-md-3">
                ...
                <hr>
                <a href="<?php echo e(url('seller/subscription')); ?>">
                    <div class="row">
                        <div class="col-md-8 offset-2">
                            <div class="row">
                                <div class="col-md-3">
                    ...
                    <div class="row">
                        <div class="col-md-8 offset-2">
                            <div class="row">
                                ...
                                <div class="col-md-7">
                                    <a style="color: #02499B;" href="<?php echo e(url('/seller/logout')); ?>">
                                    <h3>Sign Out</h3>
                                    </a>
                                </div>
                                <div class="col-md-1"></div>
...
<?php echo $__env->make('layouts.dashboard.seller', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/DMatrix/work/new/Bloomzon_v1/resources/views/dashboard/seller/profile.blade.php ENDPATH**/ ?>