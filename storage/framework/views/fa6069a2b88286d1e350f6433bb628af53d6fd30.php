		...
		<div class="container">
			<div class="row">
				<div class="col-lg-6 offset-3 text-center">
					...
					<h4>(Networking Agent)</h4>
					<div class="product-single">
						<div class="contact-form mt-sm-30">
							<h4>Login</h4>
							
							<form method="post" action="<?php echo e(url('networking_agent/login')); ?>" data-toggle="validator">
                                <?php echo csrf_field(); ?>
								<div class="row">
									<ul id="error_list"></ul>
...
unset($__errorArgs, $__bag); ?>" name="password" placeholder="Password">
									...
									<hr>
									<div class="col-sm-12 text-center pt-30">Don't have an account yet? <a href="<?php echo e(url('networking_agent/register')); ?>">Create account</a></div>
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bloomzon/bloomzon/resources/views/front/auth/networking_agent/login.blade.php ENDPATH**/ ?>