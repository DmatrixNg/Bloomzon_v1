                                            ...
                                            <div class="row">
                                                <div class=" pt-3 pb-3" style="background-color: #f2f2f2 !important;">
                                                    <div class="col-md-3 m-auto text-left">
                                                        <img src="<?php echo e(asset('storage/product/'.$favourite->product_id->avatars[0])); ?>" width="80">
                                                    </div>
...
<?php echo $__env->make('layouts.dashboard.buyer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\bloomzoon_app\resources\views/dashboard/buyer/favourites.blade.php ENDPATH**/ ?>