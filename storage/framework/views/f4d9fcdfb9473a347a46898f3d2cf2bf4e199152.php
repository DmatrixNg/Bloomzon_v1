			...
			<div class="sticker header-bottom" style="background-color: #aa1607 !important; color: #fff;">
				<div class="container-fluid mr-5 ml-5 pr-5 pl-5">
					<div class="row align-items-center">
						<div class="col-lg-2">
							<div class="logo">
								<a href="index.html"><img src="<?php echo e(asset('front_assets/assets/images/bloomzon_white.png')); ?>" width="90" height="auto" alt="logo" /></a>
							</div>
						</div>
						<div class="col-lg-6">
                                        ...
                                        <ul class="vm-dropdown" style="display: none; background-color: rgba(0,0,0,0); border: none;">
                                            <div class="row" style="width: 100vw !important; min-height: 100%; background-color: rgb(1, 54, 119, .9);">
                                                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    ...
                                                    <a href="/category/<?php echo e($category->name); ?>" style="font-size: 19px; color: white;"></i><?php echo e($category->name); ?> zzz</a>
			...
			<div class="container-fluid">
				...
				<div class="row align-items-center">
					<div class="col-sm-4 col-6">
						<div class="logo">
							<a href="<?php echo e(url('/')); ?>"><img src="<?php echo e(asset('front_assets/assets/images/bloomzon.png')); ?>" width="60" height="auto" alt="logo" /></a>
						</div>
					</div>
					<div class="col-sm-8 col-6">
						<div class="mini-cart text-right">
							<ul>
								...
								<li class="minicart-icon"><a href="<?php echo e(url('/cart')); ?>"><i class="icon_bag_alt"></i><span><?php echo e(count($cart)); ?></span></a>
								</li>
							</ul>
						</div>
					</div>
