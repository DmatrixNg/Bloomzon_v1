...
<body>
	...
	<header class="header-area pb-22"></header>
						...
						<div class="col-lg-5 col-md-5">
							...
							<div class="product-view-system pull-right" role="tablist">
								<ul class="nav nav-tabs">
									<li><a data-toggle="tab" href="#grid-products"><img src="assets/images/icons/icon-grid.png" alt="" ></a></li>
									<li><a class="active" data-toggle="tab" href="#list-products"><img src="assets/images/icons/icon-list.png" alt="" ></a></li>
								</ul>
							</div>
						</div>
					</div>
							...
							<div class="row">
								...
								<div class="col-xl-3 col-md-4 col-sm-6">
									<div class="product-single">
										...
										<div class="product-thumb">
											<a href="#"><img src="assets/images/products/shop/9.jpg" alt="" ></a>
											<div class="product-quick-view">
												<a href="javascript:void(0);" data-toggle="modal" data-target="#quick-view">quick view</a>
											</div>
										</div>
								...
								<div class="col-xl-3 col-md-4 col-sm-6">
									<div class="product-single">
										...
										<div class="product-thumb">
											<a href="#"><img src="assets/images/products/shop/12.jpg" alt="" ></a>
											<div class="product-quick-view">
												<a href="javascript:void(0);" data-toggle="modal" data-target="#quick-view">quick view</a>
											</div>
										</div>
	...
	<footer class="footer-area mt-50"></footer>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/bloomzon/resources/views/front/shop-list.blade.php ENDPATH**/ ?>