                        ...
                        <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $purchase): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="row col-md-12 mb-2 ml-1" style="border-bottom: 1px solid #f2f2f2; padding: 20px;">
                                <div class="col-md-5">
                                    ...
                                    <img src="<?php echo e(asset('storage/assets/product/avatars/'.$purchase->product->avatars[0])); ?>" width="80" alt="">
                                ...
                                <div class="row">
                                    <div class="col-md-7">
                                        ...
                                        <p><span style="font-weight: bold">Billing Address:</span> <?php echo e($purchase->buyer_id->billing_address); ?></p>
...
<?php echo $__env->make('layouts.dashboard.buyer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bloomzon/bloomzon/resources/views/dashboard/buyer/purchase-history.blade.php ENDPATH**/ ?>