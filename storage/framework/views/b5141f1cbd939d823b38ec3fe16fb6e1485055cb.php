                    ...
                    <div class="col-md-8 p-5 offset-2 " style="height: 800px;">
                        <form>
                            <div class="form-group text-center ">
                                <img src="<?php echo e(asset('storage/buyer/profile/'.$buyer->avatar)); ?>" class="img img-circle " width="120 " height="120 "><br>
...
<?php echo $__env->make('layouts.dashboard.buyer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/bloomzoon_app/resources/views/dashboard/buyer/account-information.blade.php ENDPATH**/ ?>