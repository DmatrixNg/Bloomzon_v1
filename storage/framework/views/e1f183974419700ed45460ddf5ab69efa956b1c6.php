...
<?php $__env->startSection('content'); ?>
    <div class="col-md-10">
        <a href="<?php echo e(route('fast_food_grocery.all-ads')); ?>" class="btn btn-primary">Go to All Ads</a>
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <div class="" style="color: #02499B; background-color: white; padding: 30px;">
                    ...
                    <form name="postAdvertForm" id="postAdvertForm">
                        <input name="user_id" id="user_id" type="hidden" value="<?php echo e($fast_food_grocery->id); ?>" />
                        <input name="ads_by" type="hidden" value="fast_food_grocery" />
    ...
    <script>
        ...
        function getPrice(payment_method) {
         ...
         function pay_sub() {
                ...
                var shopper_name = <?php echo json_encode($fast_food_grocery->full_name, 15, 512) ?>;
                var shopper_email = <?php echo json_encode($fast_food_grocery->email, 15, 512) ?>;       
        ...
        FormHandler('postAdvertForm', {
            requestUrl: '/fast_food_grocery/post-ads',
            requestType: 'POST',
            cb: response => {
...
<?php echo $__env->make('layouts.dashboard.fast_food_grocery', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bloomzon/bloomzon/resources/views/dashboard/fast_food_grocery/post-new-ads.blade.php ENDPATH**/ ?>