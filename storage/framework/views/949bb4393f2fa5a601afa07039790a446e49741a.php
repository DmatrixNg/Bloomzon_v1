                                ...
                                <tbody>
                                    <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $cart_item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span class="cart-product-price">$<?php echo e(number_format($cart_item->total)); ?></span>
                                            </td>
                                            <td>
                                                <div class="product-remove">
                                                    <a href="javascript:void(0)">
                                                        <i class="fa fa-times" aria-hidden="true" data-product-id="<?php echo e($cart_item->id); ?>"></i>
                                                    </a>
                                                </div>
                                            </td>
                                        </tr>
    ...
    <script>
        ...
        [...document.getElementsByClassName('fa-times')].map(element => {
            element.onclick = async e => {
                const response = await (await fetch(`/cart/remove/${e.target.getAttribute('data-product-id')}`, {
                    method: 'GET',
                    headers: {
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/bloomzoon_app/resources/views/front/cart.blade.php ENDPATH**/ ?>