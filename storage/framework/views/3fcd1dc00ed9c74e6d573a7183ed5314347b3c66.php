...
<div class="col-md-10">
    ...
    <div style="background-color: white; padding: 30px;">
        <a href="<?php echo e(url('networking_agent/edit-profile')); ?>">
          <div class="row">
              <div class="col-md-8 offset-2">
                  <div class="row">
                      <div class="col-md-3">
                          <img class="img" src="<?php echo e(asset('storage/networking_agent/'.$networking_agent->avatar)); ?>" width="80" height="80" style="border-radius: 40px" >
                      </div>
                      <div class="col-md-7">
        ...
        <hr>
        <a href="<?php echo e(url('networking_agent/account-information')); ?>">
            <div class="row">
                <div class="col-md-8 offset-2">
                    <div class="row">
                        <div class="col-md-3">
...
<?php echo $__env->make('layouts.dashboard.networking_agent', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/bloomzoon_app/resources/views/dashboard/networking_agent/profile.blade.php ENDPATH**/ ?>