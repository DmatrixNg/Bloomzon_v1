<div class="col-md-2">
    ...
    <div class="mt-3 mb-3">
        <div class="text-center mt-5 mb-5">
            <img src="<?php echo e(asset('storage/assets/buyer/avatar/'.$seller->avatar)); ?>" alt="" width="105" height="105"
        ...
        <div class="sidenav1">
            ...
            <a href="<?php echo e(route('seller.messages')); ?>"><i class="fas fa-comments mr-3"></i> Review & Feedback</a>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/bloomzoon_app/resources/views/components/dashboard/seller-side-nav.blade.php ENDPATH**/ ?>