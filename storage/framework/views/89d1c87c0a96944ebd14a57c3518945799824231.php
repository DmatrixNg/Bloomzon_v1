        ...
        <div class="container pr-0 pl-5 mr-4 ml-4" style="max-width: 95% !important; width: 100%;">
            <div class="row align-items-center">
                ...
                <div class="col-md-2 d-flex order-3">
                    ...
                    ?>
                    <div class="top-view" style="border-right: none !important;">
                        <p style="color: #02499B;"><b><?php echo e($user->id); ?></b></p>
                        <p style="color: #02499B;"><b><?php echo e(\Illuminate\Support\Carbon::parse($user->last_login)->format('Y/m/d')); ?></b></p>
                        <p style="color: #02499B;"><b><?php echo e($user->address); ?></b></p>
                    </div>
                </div>
                <!-- col.// -->
                <div class="col-md-6 order-2 order-lg-3">
                    <div class="widgets-wrap d-flex justify-content-end">
                        ...
                        <div class="widget-header ml-3">
                            <a href="#">
                                <img src="<?php echo e(asset($user->profile_pic_url)); ?>" class="img img-circle" width="80" height="80" height="auto">
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/bloomzoon_app/resources/views/dashboard/shopper/layout.blade.php ENDPATH**/ ?>