...
<?php $__env->startSection('content'); ?>
    <div class="col-md-10">
        <a href="<?php echo e(route('buyer.all-ads')); ?>" class="btn btn-primary">Go to All Ads</a>
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <div class="" style="color: #02499B; background-color: white; padding: 30px;">
                    ...
                    <form name="postAdvertForm" id="postAdvertForm">
                        <input name="user_id" id="user_id" type="hidden" value="<?php echo e($buyer->id); ?>" />
                        <input name="ads_by" type="hidden" value="buyer" />
                        ...
                        <div class="row mt-5">
                            ...
                            <div class="col-md-8">
                                <select name="payment_method" id="payment_method" onchange="setBtn()" class="form-control">
        ...
        function getPrice(payment_method) {
         ...
         function pay_sub(el) {
             ...
             el.innerHtml = "loading..."
                ...
                var buyer_name = <?php echo json_encode($buyer->full_name, 15, 512) ?>;
                var buyer_email = <?php echo json_encode($buyer->email, 15, 512) ?>;       
...
<?php echo $__env->make('layouts.dashboard.buyer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/DMatrix/work/new/Bloomzon_v1/resources/views/dashboard/buyer/post-new-ads.blade.php ENDPATH**/ ?>