				...
				<div class="col-lg-6 offset-3 text-center">
					...
					<div class="product-single">
						<div class="contact-form mt-sm-30">
							<h4>Seller's Login Form</h4>
							<form method="post" action="<?php echo e(url('seller/login')); ?>" data-toggle="validator">
                                <?php echo csrf_field(); ?>
								<div class="row">
									<ul id="error_list"></ul>
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\bloomzoon_app\resources\views/front/auth/seller/login.blade.php ENDPATH**/ ?>