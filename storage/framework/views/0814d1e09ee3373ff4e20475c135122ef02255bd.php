...
<?php $__env->startSection('content'); ?>
    <div class="col-md-10">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <form id="sub_form" action="" method="">
                    <div class="row">
                        <div class="col-md-4">
                            <label for="renewal">Renewal Plan</label>
                        </div>
                        <div class="col-md-8">
                            <select id="sub_plan" class="form-control">
                    ...
                    <div class="row mt-5">
                        <div class="col-md-4">
                            <label for="withdraw">Duration</label>
                        </div>
                        <div class="col-md-8">
...
<script>
    ...
    function pay_sub() {
        ...
        if(plan == 'basic' && duration == 7) {
            price = 5000
        } else if (plan == 'basic' && duration == 30) {
            price = 7000
        } else if (plan == 'premium' && duration == 7) {
            price = 12000
        } else if (plan == 'premium' && duration == 30) {
            price = 20000
        } else {
            return;
        }

        var seller_name = '<?php echo e(auth()->guard("seller")->user()->full_name); ?>'
...
<?php echo $__env->make('layouts.dashboard.seller', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\bloomzoon_app\resources\views/dashboard/seller/package.blade.php ENDPATH**/ ?>