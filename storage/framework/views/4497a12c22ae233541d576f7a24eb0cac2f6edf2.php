				...
				<div class="col-lg-6 offset-3 text-center">
					...
					<div class="product-single">
						<div class="contact-form mt-sm-30">
							...
							<form method="post" action="<?php echo e(url('fast_food_grocery/login')); ?>">
                                <?php echo csrf_field(); ?>
								<div class="row">
									<ul id="error_list"></ul>
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/bloomzon/resources/views/front/auth/fast_food_grocery/login.blade.php ENDPATH**/ ?>