    ...
    <div class="col-md-10">
        ...
        <div class="row col-md-12 mt-5 mb-5">
            <div class="col-md-3 text-right offset-2">
                <img class="img" src="<?php echo e(asset('storage/assets/buyer/avatar/' . $order->orderable->avatar)); ?>" width="80"
                    height="80" style="border-radius: 40px;">
            </div>
            <div class="col-md-5 text-left">

                <h4>BUYER ID:<?php echo e($order->orderable->id); ?></h4>
                <h4>LOCATION: <?php echo e($order->orderable->street_address); ?></h4>
                <h4>BILLING ADDRESS: <?php echo e($order->orderable->billing_address); ?></h4>
                                ...
                                <tbody>
                                    ...
                                    <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order_detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo e($order->orderable->billing_address); ?></td>
...
<?php echo $__env->make('layouts.dashboard.seller', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/DMatrix/work/new/Bloomzon_v1/resources/views/dashboard/seller/order-detail.blade.php ENDPATH**/ ?>