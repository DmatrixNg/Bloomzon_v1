...
<?php $__env->stopSection(); ?>
        ...
        <div class="col-md-10">
            <div class="row mt-5 mb-5" style="border-bottom: solid 1px #f2f2f2;">
                    ...
                    <div class="col-md-3 mt-4 text-right">
                        <a href="<?php echo e(route('fast_food_grocery.add-new-product')); ?>" class="btn btn-secondary">Add New Product</a>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <a href="<?php echo e(route('fast_food_grocery.edit-grocery',$product->id)); ?>" target="_blank" class="btn" style="background-color: #AF2E1D; border-radius: 5px; width: 130px; color: white; margin-top:2px">Edit</a>
        ...
        async function deleteProd(el, id) {
            return swal({
                ...
                (val) => {
                    if (val) {
                        makeRequest('/fast_food_grocery/product/delete/' + id).then(
                            (res) => {
                                console.log(res)
                                if(res.success){
        ...
        <?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.dashboard.fast_food_grocery', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bloomzon/bloomzon/resources/views/dashboard/fast_food_grocery/allproducts.blade.php ENDPATH**/ ?>