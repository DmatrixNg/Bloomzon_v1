...
<body style="background-color: #fff;">
    <?php if(Auth::guard('admin')->user()->role == 'sub_admin'): ?>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/bloomzoon_app/resources/views/layouts/dashboard/admin.blade.php ENDPATH**/ ?>