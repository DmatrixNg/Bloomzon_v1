        ...
        <div class="card p-0">
            ...
            <div class="row col-md-12 p-3 " style="padding: 20px;">
                ...
                <?php $__currentLoopData = $review->replies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reply): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($reply->reply_by->id == $buyer->id && $reply->reply_type == 'buyer'): ?>
            ...
            <div class="row col-md-12 text-center ml-1"
                ...
                <div class="form-inl  col-8 m-auto">
                    <form name="replyMsg">
                        ...
                        <input name="reply_by" value="<?php echo e(Auth::guard('buyer')->user()->id); ?>" type="hidden" />
                        <input name="reply_type" value="buyer" type="hidden" />
...
<?php echo $__env->make('layouts.dashboard.buyer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bloomzon/bloomzon/resources/views/dashboard/buyer/reply-review.blade.php ENDPATH**/ ?>