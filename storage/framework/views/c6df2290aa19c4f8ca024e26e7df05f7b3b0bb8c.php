            ...
            <table id="users-table" class="display table" style="width: 100%; cellspacing: 0;">
              ...
              <tbody>
               <?php if(count($fast_food_groceries)): ?>
                ...
                <td><?php echo e($fast_food_grocery->full_name); ?></td>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.dashboard.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bloomzon/bloomzon/resources/views/dashboard/admin/all_fast_food_groceries.blade.php ENDPATH**/ ?>