                ...
                <div class="container-fluid">
                    <div class="row align-items-center">
                        ...
                        <?php $__currentLoopData = $adverts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $advert): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($advert->advert_position === 'Header'): ?>
                                <div class="col-lg-4">
                                    <a href="<?php echo e($advert->advert_link); ?>" target="_blank">
                                        <img src="<?php echo e(asset($advert->advert_image_url1)); ?>" height="60" width="100%"
                                            class="img img-responsive">
                                    </a>
                                </div>
                            <?php endif; ?>
                                                ...
                                                <ul>
                                                    <li> <a href="/home" class="text-white mr-2"><i class="fa fa-lg fa-dashboard text-light"></i>
                                                        ...
                                                        <ul style="width:100%">
                                                            ...
                                                            <li>
                                                                <a href="/buyer/dashboard"> Logout</a>
                                                            </li>
                                                        </ul>
                                                    </li>
                                                </ul>
                                        ...
                                        <div class="mainmenu text-white">  
                                            <nav>
                                                <ul>
                                                    ...
                                                    <li><a href="fashion_designer_tailoring.html">Fashion Designer &amp; Tailoring</a></li>
                                                    <li><a href="bloomzontravels.html">Bloomzon Trip</a></li>
                                                    ...
                                                    <li class="m-auto"><a href="manufacturers.html">Manufacturers</a></li>
                                                </ul>
                                            </nav>
                                        </div>
                                </div>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/bloomzoon_app/resources/views/components/front/header-nav.blade.php ENDPATH**/ ?>