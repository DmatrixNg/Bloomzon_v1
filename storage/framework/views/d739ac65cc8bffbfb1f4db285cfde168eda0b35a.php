            ...
            <div class="col-md-6 p-5 offset-3">
                <form name="accountDetailsForm" id="accountDetailsForm">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" value="<?php echo e($fast_food_grocery->account_name); ?>" id="account_name" name="account_name" class="form-control" placeholder="">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="">
                            <label for="card_number" style="font-size: 16px;;">Card Number: </label>
                            <input type="text" value="<?php echo e(substr($fast_food_grocery->card_number,0,4)); ?>***********" name="card_number" id="card_number" class="form-control"
                    ...
                    <div class="form-group">
                        <div class="col-md-6 pl-0">
                            ...
                            <input class="d-none" placeholder="Enter bank name" name="bank_name" id="other_bank" />
                        </div>
                        <div class="col-md-6 pr-0">
                            <label for="exampleFormControlInput1" style="font-size: 16px;;">Selected Bank: </label>
                            <input type="text" value="<?php echo e($fast_food_grocery->bank_name); ?>" disabled class="form-control"
                                placeholder="No bank selected">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="exampleFormControlInput1" style="font-size: 16px;;">Account Number: </label>
                    <input type="text" class="form-control" name="account_number" value="<?php echo e($fast_food_grocery->acc_no); ?>" placeholder="0000000000">
                    </div>
                   
                    <div class="form-group">
                        <div class="col-md-6 pl-0">
                            <label for="expires_at" style="font-size: 16px;;">Expires: </label>
                        <input type="text"  value="<?php echo e($fast_food_grocery->card_expires); ?>" name="card_expires" id="card_expires" class="form-control" placeholder="02/23">
                        </div>

                        <div class="col-md-6 pl-0">
                            <label for="cvv" style="font-size: 16px;;"> cvv: </label>
                        <input type="password" value="<?php echo e($fast_food_grocery->cvv); ?>" name="cvv" id="cvv" class="form-control" placeholder="****">
                        </div>
                    </div>
...
<?php $__env->startPush('scripts'); ?>
    <script>
        FormHandler('accountDetailsForm', {
            requestUrl:'/fast_food_grocery/edit-profile/<?php echo e(Auth::guard(`fast_food_grocery`)->user()->id); ?>',
...
<?php echo $__env->make('layouts.dashboard.fast_food_grocery', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\bloomzon\resources\views/dashboard/fast_food_grocery/update-account-details.blade.php ENDPATH**/ ?>