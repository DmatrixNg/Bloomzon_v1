<?php $__env->startSection('page_title'); ?>
    Fast Food & Groceries Dashboard - Edit Profile
    ...
    <div class="col-md-10">
        <div class="row" style="padding: 40px;">
            <div class="col-md-8 offset-2 text-center mt-2 mb-5">
                ...
                <h5 class="text-center "><?php echo e($fast_food_grocery->full_name); ?></h5>
                ...
                <form name="ss" enctype="multipart/form-data">
                    ...
                    <div class="form-inline mb-5">
                        ...
                        <input style="background-color:#1A1A1A; height: 40px;" id="fullname"
                            value="<?php echo e($fast_food_grocery->full_name); ?>" type="text" name="full_name" placeholder="Anabel Olivia"
                    ...
                    <div class="form-inline mb-5">
                        ...
                        <input style="background-color:#1A1A1A; height: 40px;" id="company_name"
                            value="<?php echo e($fast_food_grocery->company_name); ?>" type="text" name="company_name" placeholder="Anabel Olivia"
                            class="col-md-10 text-white">
                    </div>

                    <div class="form-inline mb-5">
                        <div class="text-left col-md-12" style="font-size: 18px;" for="phone">Phone</div>
                        <input style="background-color:#1A1A1A; height:40px;" id="phone" value="<?php echo e($fast_food_grocery->phone_number); ?>"
                    ...
                    <div class="form-inline mb-5">
                        ...
                        <input disabled style="background-color:#1A1A1A; height: 40px;" id="email" type="email"
                            value="<?php echo e($fast_food_grocery->email); ?>" name="email" placeholder="" class="col-md-10 text-white">
                    </div>
                    ...
                    <div class="form-inline mb-5">
                        ...
                        <input style="background-color:#1A1A1A; height: 40px;" id="billing_address" name="billing_address"
                            value="<?php echo e($fast_food_grocery->billing_address); ?>" type="text" name="billing_address" placeholder=""
                            class="col-md-10 text-white">
                    </div>
...
<?php $__env->startPush('scripts'); ?>
    <script>
        var id = <?php echo json_encode($fast_food_grocery->id, 15, 512) ?>;
        FormHandler('ss', {
            requestUrl: '/fast_food_grocery/edit-profile/' + id,
            cb: response => {
                if (response.success) {
                    return swal({
                        title: 'Success!',
...
<?php echo $__env->make('layouts.dashboard.fast_food_grocery', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/bloomzoon_app/resources/views/dashboard/fast_food_grocery/edit-profile.blade.php ENDPATH**/ ?>