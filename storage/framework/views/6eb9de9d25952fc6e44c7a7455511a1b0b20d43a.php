            ...
            <div class="col-md-4">
                ...
                <?php echo csrf_field(); ?>
                    ...
                    <div class="row mt-5">
                        ...
                        <div class="col-md-8">
                            <select name="duration" id="sub_duration" class="form-control">
...
<?php echo $__env->make('layouts.dashboard.seller', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\bloomzoon_app\resources\views/dashboard/seller/subscription.blade.php ENDPATH**/ ?>