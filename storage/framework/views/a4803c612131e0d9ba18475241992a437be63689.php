            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="col-md-3 m-auto">
                        <img src="<?php echo e(asset( 'storage/product/' . $product->avatars[0] )); ?>" width="100" height="auto">
                    </div>
                    ...
                    <a href="<?php echo e(url('product-details/'.base64_encode($product->id))); ?>" target="_blank" class="btn" style="background-color: #AF2E1D; border-radius: 5px; width: 130px; color: white;margin-top:2px">View Details</a>
                        <a href="edit-product?product=<?php echo e(base64_encode(json_encode($product))); ?>" target="_blank" class="btn" style="background-color: #AF2E1D; border-radius: 5px; width: 130px; color: white; margin-top:2px">Edit</a>
...
<?php echo $__env->make('layouts.dashboard.seller', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\bloomzoon_app\resources\views/dashboard/seller/allproducts.blade.php ENDPATH**/ ?>