            ...
            <div class="row mb-3 " style=" padding: 100px; ">
                <div class="col-md-6 p-5 offset-3">
                    ...
                    <form name="updateProfile" id="updateProfile">
                        ...
                        <img src="<?php echo e(asset('storage/assets/buyer/profile/'.$buyer->avatar)); ?>" class="img img-circle"  width="100 " height="100 ">
                        </div>
...
<?php echo $__env->make('layouts.dashboard.buyer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/bloomzoon_app/resources/views/dashboard/buyer/edit-profile.blade.php ENDPATH**/ ?>