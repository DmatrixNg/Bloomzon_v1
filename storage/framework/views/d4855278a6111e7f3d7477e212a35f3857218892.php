            ...
            cb: response => {
                if (response.success) {
                    return swal({
                        ...
                        window.location.href = '/networking_agent/dashboard'
                    })
                }
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/bloomzoon_app/resources/views/front/auth/professional/login.blade.php ENDPATH**/ ?>