                ...
                <div class="col-lg-3 text-white text-left">
                    <div class="widgets-wrap d-flex justify-content-start">
                        <div class="widget-header ml-3 text-white">
                            <p><b>Available: $<?php echo e($networking_agent->wallet); ?></b></p>
                            <p><b>Net Balance: $<?php echo e($net_balance->sum('amount')); ?></b></p>
                        </div>
                    </div>
                </div>
                <!-- col.// -->
...
</header><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/bloomzon/resources/views/components/dashboard/networking-agent-header.blade.php ENDPATH**/ ?>