    ...
    <script>
        async function deleteAd(el, id) {
            return swal({
                ...
                if (val) {
                    makeRequest('/networking_agent/delete-ads/' + id).then((e)=>{
        ...
        async function changeStatus(el, id) {
            ...
            return swal({
                ...
                if (val) {
                    makeRequest('/networking_agent/change-ads-status/'+id,{status:el}).then((e)=>{
...
<?php echo $__env->make('layouts.dashboard.networking_agent', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bloomzon/bloomzon/resources/views/dashboard/networking_agent/all-ads.blade.php ENDPATH**/ ?>