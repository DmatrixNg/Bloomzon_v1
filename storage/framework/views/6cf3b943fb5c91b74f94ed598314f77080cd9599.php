...
<?php $__env->startSection('content'); ?>
    <div class="col-md-10">
            ...
            <div class="col-md-6" style="padding: 30px;">
                <div class="text-center align-items-center card" style="padding: 30px;">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <button class="btn" style="color: white; background-color: #02499B; border-radius: 5px;"><?php echo e(auth()->guard('fast_food_grocery')->user()->account_type); ?></button>
                        </div>
                    </div>
                </div>
        ...
        <div class="">
            ...
            <div class="col-md-4">
                <form id="sub_form" action="<?php echo e(url('fast_food_grocery/account_upgrade')); ?>" method="post">
                    <?php echo csrf_field(); ?>
                    <div class="row">
                        <div class="col-md-4">
...
<script>
    ...
    function pay_sub() {
        ...
        var fast_food_grocery_name = '<?php echo e(auth()->guard("fast_food_grocery")->user()->full_name); ?>'
        var fast_food_grocery_email = '<?php echo e(auth()->guard("fast_food_grocery")->user()->email); ?>'
...
<?php echo $__env->make('layouts.dashboard.fast_food_grocery', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\bloomzon\resources\views/dashboard/fast_food_grocery/upgrade_account.blade.php ENDPATH**/ ?>