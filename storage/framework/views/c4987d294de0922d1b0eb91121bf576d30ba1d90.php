        ...
        <div class="row">
            <div class="col-md-8 offset-2 card mt-5 mb-5" style="padding: 20px;">
                <form name="createSellerForm">
                    ...
                    <input type="text" value="<?php echo e($stage); ?>" name="stage" disabled/>
                    </div>
                    <br><br>
...
<?php echo $__env->make('layouts.dashboard.networking_agent', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bloomzon/bloomzon/resources/views/dashboard/networking_agent/createseller.blade.php ENDPATH**/ ?>