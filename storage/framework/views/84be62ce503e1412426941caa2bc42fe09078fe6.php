                ...
                <div class="col-lg-3 text-white text-left">
                    <div class="widgets-wrap d-flex justify-content-start">
                        <div class="widget-header ml-3 text-white">
                            <p><b>Available: N80,000</b></p>
                            <p><b>Net Balance: N120,000</b></p>
                        </div>
                    </div>
                </div>
                <!-- col.// -->
...
</header><?php /**PATH C:\xampp\htdocs\bloomzoon_app\resources\views/components/dashboard/networking-agent-header.blade.php ENDPATH**/ ?>