...
<?php $__env->stopSection(); ?>
        ...
        <div class="col-md-10">
            <div class="panel-group text-center mt-5 mb-5" id="accordion">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading p-5">
                        <a style="color: #02499B;" href="<?php echo e(url('#')); ?>">
...
<?php echo $__env->make('layouts.dashboard.seller', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/bloomzoon_app/resources/views/dashboard/seller/settings.blade.php ENDPATH**/ ?>