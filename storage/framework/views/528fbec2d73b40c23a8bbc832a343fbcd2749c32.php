                    ...
                    <?php $__currentLoopData = $food_cat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $menus): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="row col-md-12">
                            ...
                            <div class="row col-md-12 mt-5 pb-5 m-auto" style="border-bottom: 1px #dddddd solid;">
                               ...
                               <?php if($menu->category_id && $menu->category_id->id == $menus->id): ?>
...
<?php echo $__env->make('layouts.dashboard.fast_food_grocery', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bloomzon/bloomzon/resources/views/dashboard/fast_food_grocery/food-menu.blade.php ENDPATH**/ ?>