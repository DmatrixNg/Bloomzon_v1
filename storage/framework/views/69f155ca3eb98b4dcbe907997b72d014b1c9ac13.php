                    ...
                    <div class="card" style=" padding: 20px; background: #FFFFFF; box-shadow: -1px 13px 20px #F0F2F4; border-radius: 5px; width: 290px; height: 500px;">
                        ...
                        <div class="card-body">
                            ...
                            <div class="text-center">
                                ...
                                <a href="<?php echo e(url(app()->getLocale().'/manufacturer-details/'. $manufacturer->id )); ?>" class="btn btn-danger btn-sm mb-2">View dealer</a>
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Bloomzon_v1\resources\views/front/manufacturers.blade.php ENDPATH**/ ?>