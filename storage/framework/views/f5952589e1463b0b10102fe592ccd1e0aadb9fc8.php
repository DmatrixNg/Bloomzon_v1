                ...
                <div class="col-md-4 p-5">
                    <div class="card p-0">
                        ...
                        <div class="col-md-12 text-center mt-3">
                            ...
                            <p><b>Status:</b>&nbsp;&nbsp;&nbsp; <?php echo e($advert->status); ?></p>
    ...
    <script>
        async function deleteAd(el, id) {
            return swal({
                ...
                if (val) {
                    makeRequest('/seller/delete-ads/' + id).then((e)=>{
        ...
        async function changeStatus(el, id) {
            ...
            return swal({
                ...
                if (val) {
                    makeRequest('/seller/change-ads-status/'+id,{status:el}).then((e)=>{
...
<?php echo $__env->make('layouts.dashboard.seller', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bloomzon/bloomzon/resources/views/dashboard/seller/all-ads.blade.php ENDPATH**/ ?>