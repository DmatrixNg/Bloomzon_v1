                    ...
                    <?php $__currentLoopData = $payment_requests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment_request): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="mb-2 p-4" style="border-radius: 0; background-color: #5C5B78; width: 100%; color: white;">
                            <div class="col-md-4">
                                ...
                                <?php if($payment_request->user_type == 'seller'): ?>
                                <img src="<?php echo e(asset('storage/assets/seller/avatar/'.$payment_request->user_id->avatar)); ?>" class="img img-circle" width="70" height="70">
                                <?php elseif($payment_request->user_type == 'networking_agent'): ?>
                                <img src="<?php echo e(asset('storage/assets/networking_agent/avatar/'.$payment_request->user_id->avatar)); ?>" class="img img-circle" width="70" height="70">
                                <?php endif; ?>
                            </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <p class="p-0 mb-3"><span><?php echo e($payment_request->user_type); ?></span></p>
...
<?php echo $__env->make('layouts.dashboard.shopper', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bloomzon/bloomzon/resources/views/dashboard/shopper/wallet.blade.php ENDPATH**/ ?>