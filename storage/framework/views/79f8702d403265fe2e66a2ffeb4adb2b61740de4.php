...
<div class="col-md-10">
    <a href="<?php echo e(route('manufacturer.all-ads')); ?>" class="btn btn-primary">Go to All Ads</a>
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="" style="color: #02499B; background-color: white; padding: 30px;">
                ...
                <form name="postAdvertForm">
                    <input name="user_id" id="user_id" type="hidden" value="<?php echo e(auth()->guard('manufacturer')->user()->id); ?>" />
...
<?php echo $__env->make('dashboard.manufacturer.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bloomzon/bloomzon/resources/views/dashboard/manufacturer/post-new-ads.blade.php ENDPATH**/ ?>