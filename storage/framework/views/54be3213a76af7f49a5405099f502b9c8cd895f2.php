            ...
            <div class="row">
                <div class="col-lg-6 offset-3 text-center">
                    ...
                    <div class="product-single p-0 row">
                        <form method="post" action="<?php echo e(url('networking_agent/register')); ?>" class="contact-form mt-sm-30 col-md-12">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" name="phone_number" value="<?php echo e(old('phone_number')); ?>" autocomplete="phone_number" autofocus placeholder="Phone Number">
...
unset($__errorArgs, $__bag); ?>" name="password" autocomplete="password" autofocus placeholder="Password">
...
unset($__errorArgs, $__bag); ?>" name="password_confirmation" autocomplete="password_confirmation" autofocus placeholder="Confirm Password">
                                    </div>
                                    ...
                                    <hr>
                                    <div class="col-sm-12 text-center pt-30">Have an account yet? <a href="<?php echo e(url('networking_agent/login')); ?>">Login</a>
                                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bloomzon/bloomzon/resources/views/front/auth/networking_agent/register.blade.php ENDPATH**/ ?>