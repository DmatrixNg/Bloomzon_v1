...
<div class="col-md-10">
    <a href="<?php echo e(route('seller.all-ads')); ?>" class="btn btn-primary">Go to All Ads</a>
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="" style="color: #02499B; background-color: white; padding: 30px;">
                ...
                <form name="postAdvertForm">
                    <input name="user_id" id="user_id" type="hidden" value="<?php echo e($seller->id); ?>" />
...
function getPrice(payment_method) {
 ...
 function pay_sub(el) {
        ...
        var seller_name = <?php echo json_encode($seller->full_name, 15, 512) ?>;
        var seller_email = <?php echo json_encode($seller->email, 15, 512) ?>;       
...
<?php echo $__env->make('layouts.dashboard.seller', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bloomzon/bloomzon/resources/views/dashboard/seller/post-new-ads.blade.php ENDPATH**/ ?>