...
<div class="col-md-10">
    ...
    <div class="row">
        <div class="col-md-6 offset-3">
            <form id="new_user_form" onsubmit="event.preventDefault(); create_user()">
                ...
                <div class="form-group">
                    ...
                    <select style="border: 2px solid #02499B ;color: #02499B;" id="account_type" class="form-control" type="text">
                        ...
                        <option value="fast_food_groceries">Fast Food $ Groceries</option>
                ...
                <div class="form-group">
                    ...
                    <input style="border: 2px solid #02499B ;color: #02499B;" id="password" class="form-control" type="password" placeholder="Password">
                ...
                <div class="form-group">
                    ...
                    <input style="border: 2px solid #02499B ;color: #02499B;" id="password_confirmation" class="form-control" type="password" placeholder="Password">
                </div>
                <br>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('dashboard.admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\bloomzoon_app\resources\views/dashboard/admin/create_user.blade.php ENDPATH**/ ?>