                        ...
                        <div class="row footer-list border-right">
                            ...
                            <div class="col">
                                <ul>
                                    ...
                                    <li class="d-none"><a href="<?php echo e(route('home','blog')); ?>"><?php echo e(__("Blog")); ?></a> </li>
                                    <li><a href="<?php echo e(route('home','faq')); ?>"><?php echo e(__("FAQ")); ?></a> </li>
                                    <li><a href="<?php echo e(url('professional/register')); ?>"><?php echo e(__("Sell Your Services on")); ?> bloomzon</a></li>
                        ...
                        <div class="row footer-list">
                            <div class="col">
                                <ul>
                                    ...
                                    <li class="text-white pt-3"><a href="https://www.facebook.com/iou.plc.7" target="_blank" style="color: white;"> <img src="<?php echo e(asset('assets/frontend/img/facebook-logo.png')); ?>" alt="" width="20"> Facebook </a></li>
                                </ul>
                            </div>
                            <div class="col">
                                <ul>
                            ...
                            <div class="col">
                                <ul>
                                    <li class="text-white"><a href="https://www.instagram.com/bloom_zon/" target="_blank" style="color: white;"><img src="<?php echo e(asset('assets/frontend/img/insta.jpg')); ?>" alt="" width="20"> Instagram</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
...
<?php /**PATH C:\xampp\htdocs\Bloomzon_v1\resources\views/components/front/footer-nav.blade.php ENDPATH**/ ?>