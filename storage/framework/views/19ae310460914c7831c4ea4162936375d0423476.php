                    ...
                    <div class="row m-5">
                        ...
                        <div class="col-md-7">
                            <div class="" style="padding: 5px;">
                                <input type="text" name="stock_level" class="form-control" placeholder="10">
                            </div>
                        </div>
                    </div>
                    <div class="row m-5">
                    ...
                    <div class="row m-5">
                        ...
                        <div class="col-md-8">
                            <input style="border-radius: 20px; background-color: #EFEFEF;" id="price" class="form-control"
                                name="product_price" type="text" placeholder="">
                        </div>
                    </div>
                    <div class="row m-5">
                        <div class="col-md-4" style="">
                        ...
                        <div class="col-md-8">
                            <input style="border-radius: 20px; background-color: #EFEFEF;" id="dis" class="form-control"
                                name="product_sales_price" type="number" placeholder="2000">
                        </div>
                    </div>
                    <ul id="error_list"></ul>
...
<?php echo $__env->make('layouts.dashboard.seller', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/bloomzoon_app/resources/views/dashboard/seller/addnewproduct.blade.php ENDPATH**/ ?>