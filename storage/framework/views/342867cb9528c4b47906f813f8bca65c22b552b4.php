                            ...
                            <tbody>
                                <?php $__currentLoopData = $payments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr style="height: 60px;">
                                        ...
                                        <td style="border: solid 1px #ddd;"><?php echo e($payment->order_details[0]->buyer_id->full_name); ?></td>
                                        ...
                                        <td style="border: solid 1px #ddd;"><?php echo e($payment->created_at); ?></td>
                                    </tr>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.dashboard.buyer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/bloomzoon_app/resources/views/dashboard/buyer/payment-history.blade.php ENDPATH**/ ?>