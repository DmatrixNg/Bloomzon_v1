            ...
            <div class="col-md-8 p-5 offset-2">
                ...
                <form name="addProductForm">
                    ...
                    <div class="form-inline">
                        ...
                        <input type="text" name="product_sales_price" class="form-control mt-4" id="product_price" placeholder=""
                            style=" height: 40px; border-radius: 0; ">
                    </div>
...
<?php echo $__env->make('layouts.dashboard.professional', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/bloomzoon_app/resources/views/dashboard/professional/add-product.blade.php ENDPATH**/ ?>