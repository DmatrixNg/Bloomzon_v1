                ...
                <form name="ss" enctype="multipart/form-data">
                    ...
                    <div class="form-inline mb-5">
                        ...
                        <input style="background-color:#1A1A1A; height: 40px;" id="company_name"
                            value="<?php echo e($seller->company_name); ?>" type="text" name="company_name" placeholder="Anabel Olivia"
                            class="col-md-10 text-white">
                    </div>
...
<?php echo $__env->make('layouts.dashboard.seller', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\bloomzoon_app\resources\views/dashboard/seller/edit-profile.blade.php ENDPATH**/ ?>