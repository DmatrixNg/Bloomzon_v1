                ...
                <div class="col-md-4 p-5">
                    <a href="#">
                        <div class="card align-items-center" style="padding: 20px; border-radius: 20px; height: 150px;">
                            ...
                            <h5 style="color: #02499B;"><a href="/wallet-transaction-history"> Total Orders </a> </h5>
                        </div>
                    </a>
                </div>
                <div class="col-md-4 p-5">
...
<?php echo $__env->make('layouts.dashboard.seller', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\bloomzoon_app\resources\views/dashboard/seller/home.blade.php ENDPATH**/ ?>