...
<head>
    ...
    <!-- elegant css -->
    <link rel="stylesheet" href="<?php echo e(asset('assets/frontend/css/elegant.css')); ?>">
    <!-- elegant css -->
    <link rel="stylesheet" href="<?php echo e(asset('assets/frontend/css/jquery.mmenu.css')); ?>">
    <!-- jquery-ui.min css -->
    <link rel="stylesheet" href="<?php echo e(asset('assets/frontend/css/jquery-ui.min.css')); ?>">
    <!-- venobox css -->
    <link rel="stylesheet" href="<?php echo e(asset('assets/frontend/css/venobox.css')); ?>">
    <!-- slick css -->
    ...
    <!-- cssanimation css -->
    <link rel="stylesheet" href="<?php echo e(asset('assets/frontend/css/cssanimation.min.css')); ?>" />
    <!-- animate css -->
...
<!-- bootstra.min js -->
<script src="<?php echo e(asset('assets/frontend/js/bootstap.min.js')); ?>"></script>
<!-- mmenu js -->
<script src="<?php echo e(asset('assets/frontend/js/jquery.mmenu.js')); ?> "></script>
<!-- easing js -->
...
<!---letteranimation-js-->
<script src="<?php echo e(asset('assets/frontend/js/letteranimation.min.js')); ?>"></script>
<!-- jquery-ui js -->
<script src="<?php echo e(asset('assets/frontend/js/jquery-ui.mi.js')); ?>"></script>
<!-- jquery.countdown js -->
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/bloomzoon_app/resources/views/layouts/front.blade.php ENDPATH**/ ?>