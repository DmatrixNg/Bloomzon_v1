...
<?php $__env->startSection('content'); ?>
    <div class="col-md-10">
            ...
            <div class="col-md-6" style="padding: 30px;">
                <div class="text-center align-items-center card" style="padding: 30px;">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <button class="btn" style="color: white; background-color: #02499B; border-radius: 5px;"><?php echo e(auth()->guard('networking_agent')->user()->account_type); ?></button>
                        </div>
                    </div>
                </div>
        ...
        <div class="">
            ...
            <div class="col-md-4">
                <form id="sub_form" action="<?php echo e(url('networking_agent/account_upgrade')); ?>" method="post">
                    <?php echo csrf_field(); ?>
                    <div class="row">
                        <div class="col-md-4">
...
<script>
    ...
    function pay_sub() {
        ...
        var networking_agent_name = '<?php echo e(auth()->guard("networking_agent")->user()->company_name); ?>'
        var networking_agent_email = '<?php echo e(auth()->guard("networking_agent")->user()->email); ?>'
...
<?php echo $__env->make('layouts.dashboard.networking_agent', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\bloomzon\resources\views/dashboard/networking_agent/upgrade_account.blade.php ENDPATH**/ ?>