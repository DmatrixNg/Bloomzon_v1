                ...
                <div class="col-lg-3 col-sm-9 col-10 order-2 order-lg-3">
                    <div class="widgets-wrap d-flex justify-content-end">
                        ...
                        <div class="widget-header ml-3">
                            ...
                            <p type="text"  class="form-control"> Total Sales: <?php echo e(count($sales)); ?> </p>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="row" style="border: 1px solid #f2f2f2; border-radius: 5px; margin: 10px;">
                                <div class="col-md-3">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <img src="<?php echo e(asset('storage/product/'.$sale->product->avatars[0])); ?>" height="120"  alt="<?php echo e($sale->product->product_name); ?>">
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-4 text-center p-4">
                                    <p><b>BUYER:</b>  <?php echo e($sale->buyer_id->full_name); ?></p>
...
<?php echo $__env->make('layouts.dashboard.seller', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\bloomzoon_app\resources\views/dashboard/seller/sales.blade.php ENDPATH**/ ?>