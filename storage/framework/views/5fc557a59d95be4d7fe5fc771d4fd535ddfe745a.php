...
<div class="col-md-10">
    ...
    <div class="row col-md-12 text-center " style="background-color: #fff !important; padding: 10px; text-align: center !important; color:white; border-top: solid #ccc 1px; ">
        <div class="form-inline  col-md-8 m-auto">
            ...
            <input id="chat_id" type="hidden" value="<?php echo e($chat->id); ?>" />
...
jQuery(document).ready(function(e){ //when the page as completed loading start getting restaurants
    ...
    get_chat_replies('<?php echo e($chat->id); ?>')
...
function chat_replies(chat_id) {
    $.ajax({
    url: base_url + "/admin/chat/replies",
    type: "POST",
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.dashboard.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bloomzon/bloomzon/resources/views/dashboard/admin/manufacturer_chat.blade.php ENDPATH**/ ?>