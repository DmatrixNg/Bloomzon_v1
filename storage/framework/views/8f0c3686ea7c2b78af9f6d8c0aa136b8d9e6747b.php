                            ...
                            <div class="p-3">
                                <ul class="list-group" style="font-size: 18px; color: #000;">
                                    <li class="list-group-item">
                                        <br>
                                        <b>BILLING ADDRESS</b>
                                        <span class="badge badge-primary badge-pill" style="background-color: #02499B; font-size: 15px;"><?php echo e($order->order_details[0]->buyer_id->billing_address); ?></span>
                                        <br>
                                    </li>
                                    <li class="list-group-item">
                                        <br>
...
<?php echo $__env->make('layouts.dashboard.buyer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/bloomzoon_app/resources/views/dashboard/buyer/view-order-details.blade.php ENDPATH**/ ?>