...
<?php $__env->startSection('content'); ?>
    <div class="col-md-10">
        <a href="<?php echo e(route('networking_agent.all-ads')); ?>" class="btn btn-primary">Go to All Ads</a>
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <div class="" style="color: #02499B; background-color: white; padding: 30px;">
                    ...
                    <form name="postAdvertForm" id="postAdvertForm">
                        <input name="user_id" id="user_id" type="hidden" value="<?php echo e($networking_agent->id); ?>" />
                        <input name="ads_by" type="hidden" value="networking_agent" />
    ...
    <script>
        ...
        function getPrice(payment_method) {
         ...
         function pay_sub() {
                ...
                var shopper_name = <?php echo json_encode($networking_agent->full_name, 15, 512) ?>;
                var shopper_email = <?php echo json_encode($networking_agent->email, 15, 512) ?>;       
        ...
        FormHandler('postAdvertForm', {
            requestUrl: '/networking_agent/post-ads',
            requestType: 'POST',
            cb: response => {
...
<?php echo $__env->make('layouts.dashboard.networking_agent', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bloomzon/bloomzon/resources/views/dashboard/networking_agent/post-new-ads.blade.php ENDPATH**/ ?>