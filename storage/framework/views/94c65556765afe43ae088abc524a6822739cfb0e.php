            ...
            <div class="row">
                <div class="col-lg-6 offset-3 text-center">
                    ...
                    <div class="product-single p-0 row">
                        <form method="POST" class="contact-form mt-sm-30 col-md-12">
                                <?php echo csrf_field(); ?>
                            <div class="row p-5"
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <h3 class="text-white">Shopper</h3>
                                </div>
                            </div>
                            <div id="contactForm">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/bloomzoon_app/resources/views/front/auth/shopper/register.blade.php ENDPATH**/ ?>