            ...
            <div class="row">
                <div class="col-lg-6 offset-3 text-center">
                    ...
                    <div class="product-single p-0 row">
                        <form class="contact-form mt-sm-30 col-md-12" method="POST" action="<?php echo e(url('manufacturer/register')); ?>">
                        <?php echo csrf_field(); ?>

                            <div class="row p-5"
                                style="background-color: #02499B !important; border-bottom-left-radius: 20px; border-bottom-right-radius: 20px;">
                                <div class="form-group col-md-12">
                                    <h3 class="text-white">Setup A Manufacturer's Account</h3>
                                </div>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-sm-12 text-center pt-30">
                                        Have an account yet? 
                                        <a href="<?php echo e(url('Manufacturer/login')); ?>">Login</a>
                                        <br>
                                        <br>
                                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bloomzon/bloomzon/resources/views/front/auth/manufacturer/register.blade.php ENDPATH**/ ?>