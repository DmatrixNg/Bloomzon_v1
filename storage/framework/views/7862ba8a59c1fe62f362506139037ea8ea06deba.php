                        ...
                        <form class="contact-form mt-sm-30 col-md-12" name="regForm">
                            ...
                            <div class="row p-5"
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <h3 class="text-white">Professional Service</h3>
                                </div>
                            </div>
                            <div id="contactForm">
...
<?php $__env->startPush('scripts'); ?>
    <script>
        FormHandler('regForm', {
            requestUrl: '/professional/register',
            cb: response => {
                if (response.success) {
                    return swal({
                        title: 'Success!',
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/bloomzoon_app/resources/views/front/auth/professional/register.blade.php ENDPATH**/ ?>