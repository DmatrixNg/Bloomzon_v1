            ...
            <form name="createUser">
                ...
                <div class="form-group">
                    ...
                    <select style="border: 2px solid #02499B ;color: #02499B;" id="account_type" name="account_type" class="form-control" type="text">
                        ...
                        <option value="shopper">Professional Service</option>
                    </select>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.dashboard.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Bloomzon_v1\resources\views/dashboard/admin/create_user.blade.php ENDPATH**/ ?>