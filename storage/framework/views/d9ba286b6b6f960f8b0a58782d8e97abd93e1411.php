        ...
        <div class="col-md-10">
            <div class="row mb-5 mt-5">
                <div class="col-md-12 text-center">
                    <h2><img src="<?php echo e(asset('assets/dashboard/img/settings.png')); ?>" height="95" width="90"> Account Settings</h2>
                </div>
            </div>
            <div class="row">
            ...
            <div class="panel-group" id="accordion">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            ...
                            <a style="color: #02499B;" href="<?php echo e(url('admin/account-statement')); ?>">
                                <img src="<?php echo e(asset('assets/dashboard/img/filesicon.png')); ?>">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            ...
                            <a style="color: #02499B;" href="<?php echo e(url('/admin/privacy-policy')); ?>">
                                <img src="<?php echo e(asset('assets/dashboard/img/fileicon.png')); ?>">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            ...
                            <a style="color: #02499B;" href="<?php echo e(url('/admin/terms')); ?>">
                                <img src="<?php echo e(asset('assets/dashboard/img/tcicon.png')); ?>">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <a style="color: #02499B;" href="<?php echo e(url('/admin/right-of-purchase')); ?>">
                            <img src="<?php echo e(asset('assets/dashboard/img/bloomright.png')); ?>">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <a style="color: #02499B;" href="<?php echo e(url('/admin/refund')); ?>">
        
                            <img src="<?php echo e(asset('assets/dashboard/img/refundicon.png')); ?>">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <a style="color: #02499B;" href="<?php echo e(url('/admin/accountpolicy')); ?>">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <a style="color: #02499B;" href="<?php echo e(url('/admin/retailpolicy' )); ?>">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <a style="color: #02499B;" href="<?php echo e(url('/admin/cookies' )); ?>">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <a style="color: #02499B;" href="<?php echo e(url('/admin/privacy' )); ?>">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <a style="color: #02499B;" href="<?php echo e(url('/admin/refundpolicy' )); ?>">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <a style="color: #02499B;" href="<?php echo e(url('/admin/datapolicy' )); ?>">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <a style="color: #02499B;" href="<?php echo e(url('/admin/shippingreturns' )); ?>">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <a style="color: #02499B;" href="<?php echo e(url('/admin/qualitycontrol' )); ?>">
...
<?php echo $__env->make('layouts.dashboard.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Bloomzon_v1\resources\views/dashboard/admin/settings.blade.php ENDPATH**/ ?>