                                ...
                                <div class="card" style="width: 18rem;">
                                    ...
                                    <ul class="list-group list-group-flush">
                                        ...
                                        <li class="list-group-item">Buyer:
                                            <?php echo e($order->buyer_id->full_name); ?></span></p>
                                        </li>
                                        <li class="list-group-item"><p><span style="font-weight: bolder">Billing
                                            Address:</span><?php echo e($order->buyer_id->billing_address); ?>
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/DMatrix/work/sqt/bloom/resources/views/front/track-delivery.blade.php ENDPATH**/ ?>