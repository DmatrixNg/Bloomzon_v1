                ...
                <form name="addProductForm" id="addProductForm" enctype="multipart/form-data">
                    ...
                    <div class="row m-5">
                        ...
                        <div class="col-md-7">
                            <div class="" style="padding: 5px;">
                                <input value="<?php echo e($product->stock_level); ?>" type="text" name="stock_level" class="form-control" placeholder="10">
                            </div>
                        </div>
                    </div>
                    <div class="row m-5">
                    ...
                    <div class="row m-5">
                        ...
                        <input value="<?php echo e($product->minimum_order_quantity); ?>" style="border-radius: 20px; background-color: #EFEFEF;" id="qty" class="form-control"
                                type="text" name="minimum_order_quantity" placeholder="">
                        </div>
                    </div>
                    <div class="row m-5">
                        <div class="col-md-4" style="">
                    ...
                    <div class="row m-5">
                        ...
                        <div class="col-md-8">
                            <input style="border-radius: 20px; background-color: #EFEFEF;" id="price" class="form-control"
                                name="product_price" value="<?php echo e($product->product_price); ?>" type="text" placeholder="">
                        </div>
                    </div>
                    <div class="row m-5">
                        <div class="col-md-4" style="">
                        ...
                        name="product_sales_price" value="<?php echo e($product->product_sales_price); ?>" type="text" placeholder="N2,000">
                        </div>
                    </div>
                    <ul id="error_list"></ul>
...
<?php $__env->startPush('scripts'); ?>
    <script>
        ...
        FormHandler('addProductForm', {
            requestUrl: '/seller/product/update/<?php echo e($product->id); ?>',
            requestType: 'POST',
            props: {
                imgs: sto, //
                colors: colors
...
<?php echo $__env->make('layouts.dashboard.seller', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/bloomzoon_app/resources/views/dashboard/seller/editproduct.blade.php ENDPATH**/ ?>