    ...
    <div class="mt-3 mb-3">
        ...
        <div class="sidenav1">
            ...
            <div class="dropdown-container1">
                <a class="dropdown-item" href="<?php echo e(route('networking_agent.all-ads')); ?>"> All Ads</a>
                <a class="dropdown-item" href="<?php echo e(route('networking_agent.post-new-ads')); ?>"> Post New Ads</a>
            </div>
...
<?php /**PATH /home/bloomzon/bloomzon/resources/views/components/dashboard/networking-agent-side-nav.blade.php ENDPATH**/ ?>