    ...
    <div class="col-md-10">
            ...
            <div class="col-md-3 text-center m-auto">
                <a href="wallet-transaction-history">
                    <div class="p-5 m-5 m-auto" style="border-radius: 50%; border:solid #f2f2f2 10px; width: 200px; height: 200px; background-color: #5C5B78; color: white; vertical-align: middle;">
                        <div class="pt-5 m-auto">
                            <h1>$<?php echo e(number_format($professional->wallet)); ?></h1>
                        </div>
                    </div>
        ...
        <div class="row col-md-12 mt-0 mb-5" style="background-color: #2B2950 !important; padding: 20px; margin-bottom: 100px !important;">
            <form class="col-md-6 offset-3 mb-5" id="reqForm" name="paymentRequestForm">
                ...
                <input type="hidden" name="user_id" value="<?php echo e($professional->id); ?>">
...
<?php $__env->startPush('scripts'); ?>
    <script>
        var ballance = <?php echo json_encode($professional->wallet, 15, 512) ?>
    ...
    document.getElementById('sub').setAttribute('type','submit').click()
        ...
        const options = {
            requestUrl: '/professional/cashout',
            cb: response => {
                if(response.success){
                    return swal({
                        title: 'Success!',
...
<?php echo $__env->make('layouts.dashboard.professional', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/bloomzon/resources/views/dashboard/professional/wallet.blade.php ENDPATH**/ ?>