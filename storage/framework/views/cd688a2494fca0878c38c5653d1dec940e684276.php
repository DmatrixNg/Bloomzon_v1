        ...
        <div class="col-md-10">
            <div class="row mt-5 justify-content-center">
                ...
                <div class="col-md-2 text-center" style="background-color: #fff !important; padding: 15px !important;">
                    <img src="<?php echo e(asset('storage/product/'.$sale->product->avatars[0])); ?>" class="img" width="140" height="105">
                </div>
           </div>
               ...
               <div class="col-md-6 offset-3">
                   <div class="justify-content-center">
                       <div class="row text-center">
                           ...
                           <div class="col-md-6">
                               <?php echo e($sale->buyer_id->full_name); ?>
                       ...
                       <div class="row text-center">
                           ...
                           <div class="col-md-6">
                               <?php echo e($sale->buyer_id->billing_address); ?>
...
<?php echo $__env->make('layouts.dashboard.seller', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\bloomzoon_app\resources\views/dashboard/seller/saledetail.blade.php ENDPATH**/ ?>