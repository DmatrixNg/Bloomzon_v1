...
<?php $__env->stopSection(); ?>
                    ...
                    <div class="table-responsive">
                        <table id="histogram" class="display table" style="width: 100%; cellspacing: 0;">
                            ...
                            <tr>
                                ...
                                <td><a href="<?php echo e(route('fast_food_grocery.order-details',$order->id)); ?>" style="background-color: #E5E5E5; color: black;" class="btn">Details</a></td>
                            </tr>
        ...
        <?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.dashboard.fast_food_grocery', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bloomzon/bloomzon/resources/views/dashboard/fast_food_grocery/orders.blade.php ENDPATH**/ ?>