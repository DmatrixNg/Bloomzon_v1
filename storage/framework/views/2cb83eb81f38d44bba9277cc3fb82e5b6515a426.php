...
<div class="col-md-10">
    <div class="row" style="padding: 40px;">
        <div class="col-md-8 offset-2 text-center mt-2 mb-5">
            <img src="<?php echo e(asset('storage/assets/networking_agent/avatar/' . $networking_agent->avatar)); ?>" height="140" width="140" style="border-radius: 50%">
...
<?php echo $__env->make('layouts.dashboard.networking_agent', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bloomzon/bloomzon/resources/views/dashboard/networking_agent/edit-profile.blade.php ENDPATH**/ ?>