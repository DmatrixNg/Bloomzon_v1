...
class AdvertController extends Controller
{
    ...
    public function index()
    {
        ...
        $adverts = Advert::where('user_id', $this->buyer->id)->where('ads_by', 'buyer')->get();

        return view('dashboard.buyer.all-ads', compact(['adverts']));
    }
    ...
    public function create()
    {
        ...
        return view('dashboard.buyer.post-new-ads', compact(['buyer','config']));
    }
