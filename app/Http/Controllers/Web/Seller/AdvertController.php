...
class AdvertController extends Controller
{
    ...
    {
        $adverts = Advert::where('user_id',$this->seller->id)->where('ads_by','seller')->get();
        
        return view('dashboard.seller.all-ads',compact(['adverts']));
    }
    ...
    public function create()
    {
        ...
        $config = SiteConfig::where('id',1)->first(['naira','euro','pound','usd','ad1_week','ad2_week','ad4_week']);
            return view('dashboard.seller.post-new-ads',compact(['seller','config']));
