...
class AdvertController extends Controller
{
    ...
    public function index()
    {
        ...
        $adverts = Advert::where('user_id', $this->networking_agent->id)->where('ads_by', 'networking_agent')->get();

        return view('dashboard.networking_agent.all-ads', compact(['adverts']));
    }
    ...
    public function create()
    {
        ...
        return view('dashboard.networking_agent.post-new-ads', compact(['networking_agent','config']));
    }
