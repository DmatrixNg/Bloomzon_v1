...
class AdvertController extends Controller
{
    ...
    {
        $adverts = Advert::where('user_id',$this->manufacturer->id)->where('ads_by','manufacturer')->get();
        
        return view('dashboard.manufacturer.all-ads',compact(['adverts']));
    }
    ...
    public function create()
    {
        ...
        $manufacturer = $this->manufacturer;
            return view('dashboard.manufacturer.post-new-ads',compact(['manufacturer']));
