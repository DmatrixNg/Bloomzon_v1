...
class AdvertController extends Controller
{
    ...
    public function index()
    {
        ...
        $adverts = Advert::where('user_id', $this->shopper->id)->where('ads_by', 'shopper')->get();

        return view('dashboard.shopper.all-ads', compact(['adverts']));
    }
    ...
    public function create()
    {
        ...
        return view('dashboard.shopper.post-new-ads', compact(['shopper','config']));
    }
