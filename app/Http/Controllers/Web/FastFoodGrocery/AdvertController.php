...
class AdvertController extends Controller
{
    ...
    public function index()
    {
        ...
        $adverts = Advert::where('user_id', $this->fast_food_grocery->id)->where('ads_by', 'fast_food_grocery')->get();

        return view('dashboard.fast_food_grocery.all-ads', compact(['adverts']));
    }
    ...
    public function create()
    {
        ...
        return view('dashboard.fast_food_grocery.post-new-ads', compact(['fast_food_grocery','config']));
    }
