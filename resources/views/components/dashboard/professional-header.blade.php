        ...
        <div class="container pr-0 pl-5 mr-4 ml-4" style="max-width: 95% !important; width: 100%;">
            <div class="row align-items-center">
                ...
                <div class="col-md-2 d-flex order-3">
                    <div class="top-view" style="border-right: none !important;">
                        <h5 style="color: #02499B;"><b>{{$professional->company_name}}</b></h5>
                        <h5 style="color: #02499B;"><b>{{$professional->profession}}</b></h5>
                        <h5 style="color: #02499B;"><b>{{$professional->shop_address}}</b></h5>
                    </div>
                </div>
                <div class="col-md-4 d-flex order-3">
                    <div class="row">
                        ...
                        <div class="col-md-6 m-0 p-0"><h5 class="m-0 p-2" style="color: #02499B;"><b>${{$professional->wallet}}</b></h5></div>
                        <div class="col-md-6 m-0 p-0"><h5 class="m-0 p-2" style="color: #02499B;"><b>Net Balance</b></h5></div>
                        <div class="col-md-6 m-0 p-0"><h5 class="m-0 p-2" style="color: #02499B;"><b>${{$professional->wallet - $networth->sum('amount') }}</b></h5></div>
                    </div>
                </div>
                <!-- col.// -->
                <div class="col-md-2 order-2 order-lg-3">
                    <div class="widgets-wrap d-flex justify-content-end">
                        ...
                        <div class="widget-header ml-3 text-center">
                            <a href="#">
                                <img class="img" src="{{asset('storage/assets/professional/avatar/'.$professional->avatar)}}" width="80" height="80" style="border-radius: 40px" >
                                <p class="text-center">{{$professional->full_name}}</p>
                            </a>
                        </div>
                    </div>
                    <!-- widgets-wrap.// -->
