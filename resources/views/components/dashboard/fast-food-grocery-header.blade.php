        ...
        <div class="container pr-0 pl-5 mr-4 ml-4" style="max-width: 95% !important; width: 100%;">
            <div class="row align-items-center">
                ...
                <div class="col-md-2 d-flex order-3">
                    <div class="top-view" style="border-right: none !important;">
                        <h5 style="color: #02499B;"><b>{{$fast_food_grocery->company_name}}</b></h5>
                        <h5 style="color: #02499B;"><b>{{date($fast_food_grocery->created_at)}}</b></h5>
                        <h5 style="color: #02499B;"><b>{{$fast_food_grocery->shop_address}}</b></h5>
                    </div>
                </div>
                <!-- col.// -->
                    ...
                    <div class="widgets-wrap d-flex justify-content-end">
                        ...
                        <div class="widget-header ml-3 text-center">
                            <a href="#">
                                ...
                                <p class="text-center">{{ auth()->guard('fast_food_grocery')->user()->company_name }}</p>
                            </a>
                        </div>
                    </div>
                    <!-- widgets-wrap.// -->
