    ...
    <section class="header-top2 m-0 p-0">
        <div class="container-fluid">
            <div class="row align-items-center">
                ...
                <a href="/"> <img class="logo" src="{{asset('assets/dashboard/img/bloomzon.png')}}" alt="logo" width="80" height="auto"></a>
                </div>
                ...
                <div class="col-lg-3 text-white text-left">
                    <div class="widgets-wrap d-flex justify-content-start">
                        <div class="widget-header ml-3 text-white">
                                ...
                                <p><b>Available: {{number_format($seller->wallet)}}</b></p>
                                <p><b>Net Balance: {{number_format($networth->sum('amount'))}}</b></p>
