        ...
        <div class="container pr-0 pl-5 mr-4 ml-4" style="max-width: 95% !important; width: 100%;">
            <div class="row align-items-center">
                ...
                <div class="col-md-2 d-flex order-3">
                    <div class="top-view" style="border-right: none !important;">
                        <h5 style="color: #02499B;"><b>{{$shopper->id}}</b></h5>
                        <h5 style="color: #02499B;"><b>{{$shopper->last_login}}</b></h5>
                        <h5 style="color: #02499B;"><b>{{$shopper->street_address}}</b></h5>
                    </div>
                </div>
                <!-- col.// -->
                <div class="col-md-6 order-2 order-lg-3">
                    <div class="widgets-wrap d-flex justify-content-end">
                        ...
                        <div class="widget-header ml-3">
                            <a href="#">
                                <img src="{{asset('storage/assets/shopper/avatar/'.$shopper->avatar)}}" class="img img-circle m-auto" width="100" height="100">
                                <p class="text-center">{{$shopper->email}}</p>
                            </a>
                        </div>
                    </div>
                    <!-- widgets-wrap.// -->
