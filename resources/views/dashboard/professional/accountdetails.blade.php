...
@section('page_title')
    professional's Dashboard - Payment Account Details
@endsection
@section('content')
    <div class="col-md-10">
            ...
            <div class="col-md-6 p-5 offset-3">
                ...
                <div class="form-group">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="input_acc_num" name="account_number" value="{{ $professional->account_number }}"
                ...
                <form action="{{ url('professional/update_account_details') }}" method="POST">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <div id="verify_details" class="">
                            <div class="form-group">
                                ...
                                <input type="text" id="account_name" class="form-control disabled" name="account_name" value="{{ $professional->account_name }}"
                        ...
                        <div id="verify_details" class="">
                            <div class="form-group">
                                ...
                                <input type="text" id="account_number" class="form-control" name="account_number" value="{{ $professional->account_number }}"
                        ...
                        <div id="verify_details" class="">
                            <div class="form-group">
                                ...
                                <input type="text" id="bank_name" class="form-control" name="bank_name" value="{{ $professional->bank_name }}"
                        ...
                        <div id="verify_details" class="">
                            <div class="form-group">
                                ...
                                <input type="text" id="bank_code" class="form-control" name="bank_code" value="{{ $professional->bank_code }}"
                                placeholder="Bank Code" readonly>
                            </div>
                        </div>

                    </div>
                    {{-- @if($professional->account_bank_name =="" ) --}}
                ...
                <form action="{{url("professional/update_paypal_details")}}" method="post">
                    <div class="form-group">
                      @csrf
                        <h2 style="color: green; text-align: center;"><strong>For Professional Services outside Africa</strong></h2>
                        <div class="form-group">
                            <label for="exampleFormControlInput1" style="font-size: 16px;;">Paypal Email: </label>
                            <input type="email" class="form-control" name="email" value="{{ $professional->paypal_email }}"
                            placeholder="">
                            <div class="form-group text-center">
                                <div id="error_list"></div>
                                <br>
...
@push('scripts')
    <script>
        ...
        //     requestUrl: '/professional/edit-bank/{{ Auth::guard(`professional`)->user()->id }}',
