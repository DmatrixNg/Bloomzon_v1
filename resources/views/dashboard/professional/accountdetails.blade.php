                ...
                <form name="accountDetailsForm" id="accountDetailsForm">
                    ...
                    <div class="form-group">
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ $professional->account_name }}" id="account_name" name="account_name"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 pr-0">
                            ...
                            <input type="text" value="{{ $professional->bank_name }}" disabled class="form-control"
                                placeholder="No bank selected">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="exampleFormControlInput1" style="font-size: 16px;;">Account Number: </label>
                        <input type="text" class="form-control" name="account_number" value="{{ $professional->account_number }}"
...
@push('scripts')
    <script>
        ...
        FormHandler('accountDetailsForm', {
            requestUrl: '/professional/edit-bank-account/{{ Auth::guard(`professional`)->user()->id }}',
