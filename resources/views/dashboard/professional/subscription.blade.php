...
@section('content')
    <div class="col-md-10">
        ...
        @if(auth()->guard('professional')->user()->is_subscribed())
            <div class="">
                ...
                <div class="col-md-6" style="padding: 30px;">
                    <div class="text-center align-items-center card" style="padding: 30px;">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <button class="btn text-capitalize" style="color: white; background-color: #02499B; border-radius: 5px;">{{ auth()->guard('professional')->user()->is_subscribed()->package }}</button>
                            </div>
                            ...
                            <div class="col-md-6">
                                <button class="btn text-capitalize" style="color: white; background-color: #02499B; border-radius: 5px;">{{ auth()->guard('professional')->user()->is_subscribed()->start_date }}</button>
                            </div>
                            ...
                            <div class="col-md-6">
                                <button class="btn text-capitalize" style="color: white; background-color: #02499B; border-radius: 5px;">{{ auth()->guard('professional')->user()->is_subscribed()->end_date }}</button>
                            </div>
                        </div>
                    </div>
        ...
        @else
            ...
            <div class="">
                ...
                <div class="col-md-4">
                    <form id="sub_form" action="{{ url('professional/create_subscription') }}" method="post">
                        @csrf
                        <div class="row">
                            <div class="col-md-4">
...
<script>
    ...
    function pay_sub() {
        ...
        var professional_name = '{{ auth()->guard("professional")->user()->company_name }}'
        var professional_email = '{{ auth()->guard("professional")->user()->email }}'
