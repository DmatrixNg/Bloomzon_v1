        ...
        <div class="card p-0">
            ...
            <div class="row col-md-12 p-3 " style="padding: 20px;">
                ...
                @foreach ($review->replies as $reply)
                    @if ($reply->reply_by->id == $professional->id && $reply->reply_type == 'professional')
                    <div class="row col-md-12 p-3 " style="padding: 20px;">
            ...
            <div class="row col-md-12 text-center ml-1"
                ...
                <div class="form-inl  col-8 m-auto">
                    <form name="replyMsg">
                        ...
                        <input name="reply_by" value="{{ Auth::guard('professional')->user()->id }}" type="hidden" />
                        <input name="reply_type" value="professional" type="hidden" />
...
@push('scripts')
    ...
    <script>
        FormHandler('replyMsg', {
            requestUrl: '/professional/reply-review',
            requestType: 'POST',
