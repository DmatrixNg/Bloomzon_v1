...
@section('content')
    <div class="col-md-10">
            ...
            <div class="col-md-6" style="padding: 30px;">
                <div class="text-center align-items-center card" style="padding: 30px;">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <button class="btn" style="color: white; background-color: #02499B; border-radius: 5px;">{{ auth()->guard('manufacturer')->user()->subscription_plan }}</button>
                        </div>
                    </div>
                </div>
        ...
        <div class="">
            ...
            <div class="col-md-4">
                <form id="sub_form" action="{{ url('manufacturer/subscribe') }}" method="post">
                    @csrf
                    <div class="row">
                        <div class="col-md-4">
