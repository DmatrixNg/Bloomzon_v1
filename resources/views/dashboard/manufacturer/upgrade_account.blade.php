...
@section('content')
    <div class="col-md-10">
            ...
            <div class="col-md-6" style="padding: 30px;">
                <div class="text-center align-items-center card" style="padding: 30px;">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <button class="btn" style="color: white; background-color: #02499B; border-radius: 5px;">{{ auth()->guard('manufacturer')->user()->account_type }}</button>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <form id="sub_form" action="{{ url('manufacturer/upgrade_account') }}" method="post">
                    @csrf
                    <div class="row">
                        <div class="col-md-4">
...
<script>
    ...
    function pay_sub() {
        ...
        var manufacturer_full_name = '{{ auth()->guard("manufacturer")->user()->full_name }}'
        ...
        if(payment_method == 'paypal') {
            ...
            payment_handler.pay_with_paystack({
                ...
                amount    : price,
                curency   : 'NGN',
                first_name: manufacturer_full_name,
                last_name : manufacturer_full_name,
                reference : makeid(10),
