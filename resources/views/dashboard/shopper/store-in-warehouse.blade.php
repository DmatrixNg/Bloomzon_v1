                    ...
                    <div class="col-md-4 p-3 mb-4">
                        <div class="card p-2 " style="box-shadow: 0 4px 8px 0 rgba(0,0,0,0.1); border-radius: 0px !important;">
                            ...
                            <div class="row m-auto">
                                <div class="col-md-2">
                                    <img src="{{ asset('storage/assets/product/avatars/' . $prod->order_details->product->avatars[0]) }}"
                            ...
                            <div class="row text-center">
                                <div class="col-md-12">
                                    <p><span style="font-weight: bolder">Product:</span><span
                                            class="pl-2">{{ $prod->order_details->product->product_name }}</span></p>
                                </div>
                                <div class="col-md-12">
                                    <p><span style="font-weight: bolder">Location:</span><span
                                            class="pl-2">{{ $prod->storage_location }}</span></p>
                                </div>
                               
                                <div class="col-md-12 text-center mt-2">
                                    <a href="{{ route('shopper.delivery-details', $prod->id) }}" type="button"
                        ...
                        <form name="packageForm">
                            ...
                            <div class="form-inline pt-2 ">
                                <label for="exampleFormControlInput1 " class="col-md-4 " style="font-size: 16px;; ">Billing
                                    Address: </label>
                                <input type="text" class="form-control col-md-8" disabled
                                    value="{{ $order->order->billing_address }}" style="height: 40px; border-radius: 0; ">
                            </div>
                            <div class="form-inline pt-2 ">
                            ...
                            <div class="form-inline pt-2 ">
                                ...
                                <input type="text" name="amount" class="form-control col-md-8" disabled
                                    value="{{ number_format($order->order->total_amount) }}"
                                    style="height: 40px; border-radius: 0; ">
                            </div>
                            <div class="form-inline pt-2 ">
                                <label for="delivery_fee" class="col-md-4" style="font-size: 16px;; ">Delivery Fee: </label>
                                <input type="text " class="form-control col-md-8"
                                    value="{{ number_format($order->order->delivery_fee) }}"
                                    style="height: 40px; border-radius: 0; ">
                            </div>
                ...
                cb: response => {
                    if (response.success) {
                        return swal({
                            ...
                            window.location.href = '/shopper/scan-code/{{ $order->id }}';
                        })
                    }
