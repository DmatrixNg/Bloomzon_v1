                    ...
                    @foreach($sales as $sale)
                        <div class="col-md-6">
                            <div class="row" style="border: 1px solid #f2f2f2; border-radius: 5px; margin: 10px;">
                                ...
                                <a href="{{url('seller/sales/show/'.base64_encode(json_encode($sale)))}}" class="btn" style="background-color: #AF2E1D; border-radius: 5px; width: 130px; color: white;">View Details</a>
                                </div>
                            </div>
                        </div>
