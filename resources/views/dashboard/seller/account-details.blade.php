                ...
                <form name="accountDetailsForm" id="accountDetailsForm">
                    ...
                    <div class="form-group">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="account_name" name="account_number" value="{{ $seller->account_number }}"
                    ...
                    <div class="form-group">
                        ...
                        <div id="verify_details" class="">
                            <div class="form-group">
                                ...
                                <input type="text" id="verified_account_name" class="form-control" name="account_name" value="{{ $seller->account_name }}"
                        ...
                        <div id="verify_details" class="">
                            <div class="form-group">
                                ...
                                <input type="text" id="verified_account_number" class="form-control" name="account_number" value="{{ $seller->account_number }}"
                        ...
                        <div id="verify_details" class="">
                            <div class="form-group">
                                ...
                                <input type="text" id="verified_bank_name" class="form-control" name="bank_name" value="{{ $seller->bank_name }}"
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="" class="form-control" name="account_number" value="{{ $seller->account_number }}"
                            placeholder="">
                            <div class="form-group text-center">
                                <div id="error_list"></div>
                                <br>
