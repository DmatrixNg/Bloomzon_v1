...
@endsection
        ...
        <div class="col-md-10">
            ...
            <div style="background-color: white; padding: 30px;">
                <a href="{{url('seller/edit-profile')}}">
                  <div class="row">
                      <div class="col-md-8 offset-2">
                          <div class="row">
                              <div class="col-md-3">
                                  <img class="img" src="{{asset('storage/assets/seller/avatar/'.$seller->avatar)}}" width="80" height="80" style="border-radius: 40px" >
                              </div>
                              <div class="col-md-7">
                ...
                <hr>
                <a href="{{url('seller/update-account-details')}}">
                    <div class="row">
                        <div class="col-md-8 offset-2">
                            <div class="row">
                                <div class="col-md-3">
                    ...
                    <div class="row">
                        <div class="col-md-8 offset-2">
                            <div class="row">
                                ...
                                <div class="col-md-7">
                                    <a style="color: #02499B;" href="{{url('/seller/logout')}}">
                                    <h3>Sign Out</h3>
                                    </a>
                                </div>
                                <div class="col-md-1"></div>
