                        ...
                        @foreach($orders as $purchase)
                            <div class="row col-md-12 mb-2 ml-1" style="border-bottom: 1px solid #f2f2f2; padding: 20px;">
                                <div class="col-md-5">
                                    ...
                                    <img src="{{asset('storage/assets/product/avatars/'.$purchase->product->avatars[0])}}" width="80" alt="">
                                ...
                                <div class="row">
                                    <div class="col-md-7">
                                        ...
                                        <p><span style="font-weight: bold">Billing Address:</span> {{$purchase->buyer_id->billing_address}}</p>
