...
@section('content')
    <div class="col-md-10">
        <a href="{{ route('buyer.all-ads') }}" class="btn btn-primary">Go to All Ads</a>
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <div class="" style="color: #02499B; background-color: white; padding: 30px;">
                    ...
                    <form name="postAdvertForm" id="postAdvertForm">
                        <input name="user_id" id="user_id" type="hidden" value="{{ $buyer->id }}" />
        ...
        function getPrice(payment_method) {
         ...
         function pay_sub(el) {
             ...
             el.innerHtml = "loading..."
                ...
                var buyer_name = @json($buyer->full_name);
                var buyer_email = @json($buyer->email);       
