        ...
        @section('content')
            <div class="col-md-10">
                ...
                <div class="row col-md-12 p-3 " style="background-color: #fff !important; padding: 20px; ">
                    <div class="col-md-4 offset-8 p-3 ">
                        <div class="row ">
                            <div class="col-md-6 text-left ">Dec 20, 2020</div>
                ...
                <div class="row col-md-12 p-3 " style="background-color: #fff !important; padding: 20px; ">
                    <div class="col-md-4 p-3 "  style="border: 1px solid #ddd; border-radius: 5px ">
                        ...
                        <p>Thank you for reaching us, we are currently attending to your issues</p>
                    </div>
                </div>
                <div class="row col-md-12 p-3 " style="background-color: #fff !important; padding: 20px; ">
                    <div class="col-md-4 offset-8 p-3 ">
                ...
                <div class="row col-md-12 text-center mb-5" style="background-color: #fff !important; padding: 10px; text-align: center !important; color:white; border-top: solid #ccc 1px; ">
                    <div class="form-inline  col-md-8 m-auto">
                        <input type="text " class="form-control col-10" style="height: 40px; border-radius: 0px;">
                        <button class="btn btn-danger btn-sm col-2" style="height: 40px; border-radius: 0px;">Send</button>
                    </div>
                </div>
            </div>
        @endsection
