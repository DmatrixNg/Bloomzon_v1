                            ...
                            @foreach($requests as $request)
                                <tr>
                                    ...
                                    @if($request->status == 0)
                                        ...
                                        <td>
                                            <select class="form-control p-1 checkout_options" data-account_number="0177344478" data-bank_code="058" data-amount="{{$request->amount}}" data-bank_name="{{$request->user_id->bank_name}}">
