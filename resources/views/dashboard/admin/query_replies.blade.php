...
<div class="col-md-10">
    ...
    @if(auth()->guard('admin')->user()->role == 'super_admin')
        <form action="{{ url('admin/super_admin_reply/' . $query_id) }}" method="post" class="row col-md-12 text-center mb-5" style="background-color: #fff !important; padding: 10px; text-align: center !important; color:white; border-top: solid #ccc 1px; ">
        @csrf
    ...
    @else
        ...
        <form action="{{ url('admin/sub_admin_reply/' . $query_id) }}" method="post" class="row col-md-12 text-center mb-5" style="background-color: #fff !important; padding: 10px; text-align: center !important; color:white; border-top: solid #ccc 1px; ">
        @csrf
            <div class="col-12 text-center">
                <textarea class="form-control" name="message"></textarea>
            </div>
