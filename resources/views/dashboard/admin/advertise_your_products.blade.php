            ...
            <div class="row mb-5 mt-5">
                ...
                <div class="row mb-5" style="background-color: white; height: 450px;  padding: 50px;">
                    <div class="col-md-10 offset-1 text-center">
                        <textarea class="form-control mb-5" id="pp" rows="40">{{\App\SiteConfig::find(1)->advertise_your_products }}</textarea>
    ...
    @push('scripts')
        <script>
            function saveInput(){
                ...
                makeRequest("/admin/save-setting",{data: data,type: 'advertise_your_products'}).then((e)=>{
                    console.log(e)
                    if(e.success){
