...
@section('content')
    <div class="col-md-10">
        <a href="{{ route('networking_agent.all-ads') }}" class="btn btn-primary">Go to All Ads</a>
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <div class="" style="color: #02499B; background-color: white; padding: 30px;">
                    ...
                    <form name="postAdvertForm" id="postAdvertForm">
                        <input name="user_id" id="user_id" type="hidden" value="{{ $networking_agent->id }}" />
    ...
    <script>
        ...
        function getPrice(payment_method) {
         ...
         function pay_sub() {
                ...
                var shopper_name = @json($networking_agent->full_name);
                var shopper_email = @json($networking_agent->email);       
