            ...
            <div class="col-md-6 p-5 offset-3">
                ...
                <div class="form-group">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="input_acc_num" name="account_number" value="{{ $networking_agent->account_number }}"
                    ...
                    <div class="form-group">
                        ...
                        <div id="verify_details" class="">
                            <div class="form-group">
                                ...
                                <input type="text" id="account_name" class="form-control disabled" name="account_name" value="{{ $networking_agent->account_name }}"
                        ...
                        <div id="verify_details" class="">
                            <div class="form-group">
                                ...
                                <input type="text" id="account_number" class="form-control" name="account_number" value="{{ $networking_agent->account_number }}"
                        ...
                        <div id="verify_details" class="">
                            <div class="form-group">
                                ...
                                <input type="text" id="bank_code" class="form-control" name="bank_code" value="{{ $networking_agent->bank_code }}"
