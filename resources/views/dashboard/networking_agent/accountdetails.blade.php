            ...
            <div class="col-md-6 p-5 offset-3">
                <form name="accountDetailsForm" id="accountDetailsForm">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" value="{{$networking_agent->account_name}}" id="account_name" name="account_name" class="form-control" placeholder="">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 pr-0">
                            ...
                            <input type="text" value="{{ $networking_agent->account_bank_name }}" disabled class="form-control"
                                placeholder="No bank selected">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="exampleFormControlInput1" style="font-size: 16px;;">Account Number: </label>
                    <input type="text" class="form-control" name="account_number" value="{{$networking_agent->account_number}}" placeholder="0000000000">
                    </div>
...
@push('scripts')
    <script>
        ...
        FormHandler('accountDetailsForm', {
            requestUrl:'/networking_agent/edit-bank-account/{{Auth::guard(`networking_agent`)->user()->id}}',
