            ...
            <div class="col-md-6 p-5 offset-3">
                ...
                <div class="form-group">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="input_acc_num" name="account_number" value="{{ $fast_food_grocery->account_number }}"
                ...
                <form action="{{ url('fast_food_grocery/update_account_details') }}" method="POST">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <div id="verify_details" class="">
                            <div class="form-group">
                                ...
                                <input type="text" id="account_name" class="form-control disabled" name="account_name" value="{{ $fast_food_grocery->account_name }}"
                        ...
                        <div id="verify_details" class="">
                            <div class="form-group">
                                ...
                                <input type="text" id="account_number" class="form-control" name="account_number" value="{{ $fast_food_grocery->account_number }}"
                        ...
                        <div id="verify_details" class="">
                            <div class="form-group">
                                ...
                                <input type="text" id="bank_name" class="form-control" name="bank_name" value="{{ $fast_food_grocery->bank_name }}"
                        ...
                        <div id="verify_details" class="">
                            <div class="form-group">
                                ...
                                <input type="text" id="bank_code" class="form-control" name="bank_code" value="{{ $fast_food_grocery->bank_code }}"
                ...
                <form action="{{url("fast_food_grocery/update_paypal_details")}}" method="post">
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" name="email"  value="{{ $fast_food_grocery->paypal_email }}"
                            placeholder="">
                            <div class="form-group text-center">
                                <div id="error_list"></div>
                                <br>
