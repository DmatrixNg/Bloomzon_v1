        ...
        <div class="col-md-10">
            <div class="row mt-5 mb-5" style="border-bottom: solid 1px #f2f2f2;">
                    ...
                    <div class="col-md-3 mt-4 text-right">
                        <a href="{{route('fast_food_grocery.add-new-product')}}" class="btn btn-secondary">Add New Product</a>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <a href="{{route('fast_food_grocery.edit-grocery',$product->id)}}" target="_blank" class="btn" style="background-color: #AF2E1D; border-radius: 5px; width: 130px; color: white; margin-top:2px">Edit</a>
