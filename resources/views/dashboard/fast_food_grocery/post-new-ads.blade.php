...
@section('content')
    <div class="col-md-10">
        <a href="{{ route('fast_food_grocery.all-ads') }}" class="btn btn-primary">Go to All Ads</a>
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <div class="" style="color: #02499B; background-color: white; padding: 30px;">
                    ...
                    <form name="postAdvertForm" id="postAdvertForm">
                        <input name="user_id" id="user_id" type="hidden" value="{{ $fast_food_grocery->id }}" />
                        ...
                        <div class="row mt-5">
                            ...
                            <div class="col-md-8">
                                <select name="payment_method" onchange="setBtn()" id="payment_method" class="form-control">
        ...
        function setBtn(){
         ...
         function pay_sub(el) {
             ...
             el.innerHtml = "loading..."
                ...
                var shopper_name = @json($fast_food_grocery->full_name);
                var shopper_email = @json($fast_food_grocery->email);       
