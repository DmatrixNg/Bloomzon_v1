            ...
            <div class="card" style=" padding: 20px; background: #FFFFFF; box-shadow: -1px 13px 20px #F0F2F4; border-radius: 5px; width: 290px; height: 500px;">
                ...
                <div class="card-body">
                    <div class="text-center">
                        ...
                        <a href="{{url('/seller-product-list/'.$seller->id)}}" class="btn btn-danger border-0 h2">View Products</a>
                        <a href="{{url('/seller-details/'.$seller->id)}}" class="btn btn-primary border-0 h2">View Store</a>
                    </div>
                    <br>
                    <!-- Quotation -->
