            ...
            <div class="row">
                    ...
                    <div class="tab-content">
                        <div id="product-1" class="tab-pane fade in show active">
                            <div class="product-details-thumb">
                                ...
                                <img src="{{asset('storage/assets/fast_food_grocery/avatar/'.$fast_food_grocery->avatar)}}" width="100%" height="450" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-5 mt-sm-50">
                    <div class="product-details-desc">
                        <h3><small>NAMES:</small> <span class="pl-5">{{$fast_food_grocery->shop_name}}</span></h3>
                        <h3><small>REPRESENTATIVE NAME:</small> <span class="pl-5">{{$fast_food_grocery->full_name}}</span></h3>
                        <h3><small>LOCATION: </small> <span class="pl-4">{{$fast_food_grocery->shop_address}}</span></h3>
                        <h3><small>DESCRIPTION OF SERVICE: </small></h3>
                        <p>{{$fast_food_grocery->service_description}}.</p>
                        <h3><small>CONTACT NUMBER: </small> <span class="pl-4">{{$fast_food_grocery->phone}}</span></h3>
                        <h3><small>CONTACT EMAIL: </small> <span class="pl-5">{{$fast_food_grocery->email}}</span></h3>
                        <h3><small>LAST SEEN: </small> <span class="pl-5">{{$fast_food_grocery->last_login}}</span></h3>
                ...
                <div class="tab-content">
                        ...
                        <div class="product-description">
                            ...
                            <div class="products-tab mt-35">
                                <div class="row cv-visible">
                                    @if(count($food_cats))
                                    @foreach($food_cats as $food_menu)
                                    <div class="col-lg-2">
                    ...
                    <div id="termscond" class="tab-pane fade termscond">
                        <div class="product-description">
                            ...
                            <p>{{$fast_food_grocery->terms_and_conditions}}</p>
                        </div>
                    </div>
                    <div id="deliverymet" class="tab-pane fade deliverymet">
                        <div class="product-description">
                            <h2>Delivery Method</h2>
                        <p>{{$fast_food_grocery->delivery_terms}}</p>
                        </div>
                    </div>
                        ...
                        <div class="best-sellers mt-45">
                            <div class="container-fluid fix">
                                <div class="row four-items cv-visible">
                                    @if(count($fast_food_grocery->products))
                                    @foreach($fast_food_grocery->products as $product)
                                    <div class="col-lg-3">
                    ...
                    <div id="reviews" class="tab-pane fade">
                        <div class="blog-comments product-comments mt-0">
                            <ul class="list-none">
                               @if(count($fast_food_grocery->reviews))
                                @foreach ($fast_food_grocery->reviews as $review )
                                <li>
