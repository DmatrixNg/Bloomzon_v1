                                    ...
                                    <div class="row product-categories-carousel mt-30 slick-initialized slick-slider">
                                        <div class="slick-list draggable">
                                            <div class="slick-track"
                                                ...
                                                @foreach($manufacturers->take(9) as $manufacturer)
                        ...
                        <div class="products-tab mt-35">
                            <div class="row" style="background-color: #0149a0 !important; color: #fff;">
                                <div class="col-lg-12">
                                    <div class="section-title text-left">
                                        <h3>{{ __("GROCERIES")}}
                                            <a href="{{ app()->getLocale() . '/groceries' }}"
                        ...
                        <div class="products-tab mt-35">
                            <div class="row" style="background-color: #0149a0 !important; color: #fff;">
                                <div class="col-lg-12">
                                    <div class="section-title text-left">
                                        <h3>{{ __("FOOD MENUS")}}
                                            <a href="{{ app()->getLocale() . '/food-menus' }}"
                                                class="text-white pull-right"> {{ __("SEE ALL")}}</a>
                                        </h3>
                                    </div>
                                </div>
                        ...
                        <div class="best-sellers">
                            ...
                            <div class="row cv-visible">
                                <div class="col-4 col-md-3 col-lg-2">
                                    ...
                                    <div class="product-single p-0 svh" style="background-image: url('{{asset("assets/frontend/img/food1.jpg")}}'); height: 220px; border-radius: 15px; background-size: cover; width: 100%;  background-repeat: no-repeat; background-position: center;">
                                ...
                                <div class="col-4 col-md-3 col-lg-2">
                                    ...
                                    <div class="product-single p-0 svh" style="background-image: url('{{asset("assets/frontend/img/g2.jpg")}}'); height: 220px; border-radius: 15px; background-size: cover; background-position: center;">
                                        <div class="product-title pt-2" style=" width: 100%; background-color: #23374D; opacity: 0.8; position: absolute; bottom: 0; text-align: center; border-bottom-right-radius: 15px; border-bottom-left-radius: 15px;">
                                ...
                                <div class="col-4 col-md-3 col-lg-2">
                                    ...
                                    <div class="product-single p-0 svh" style="background-image: url('{{asset("assets/frontend/img/b3.jpg")}}'); height: 220px; border-radius: 15px; background-size: cover; background-position: center;">
                                        <div class="product-title pt-2" style=" width: 100%; background-color: #23374D; opacity: 0.8; position: absolute; bottom: 0; text-align: center; border-bottom-right-radius: 15px; border-bottom-left-radius: 15px;">
                                ...
                                <div class="col-4 col-md-3 col-lg-2">
                                    ...
                                    <div class="product-single p-0 svh" style="background-image: url('{{asset("assets/frontend/img/b1.jpeg")}}'); height: 220px; border-radius: 15px; background-size: cover; background-position: center;">
                                        <div class="product-title pt-2" style=" width: 100%; background-color: #23374D; opacity: 0.8; position: absolute; bottom: 0; text-align: center; border-bottom-right-radius: 15px; border-bottom-left-radius: 15px;">
                                ...
                                <div class="col-4 col-md-3 col-lg-2">
                                    ...
                                    <div class="product-single p-0 svh" style="background-image: url('{{asset("assets/frontend/img/p1.jpg")}}'); height: 220px; border-radius: 15px; background-size: cover; background-position: center;">
                                        <div class="product-title pt-2" style=" width: 100%; background-color: #23374D; opacity: 0.8; position: absolute; bottom: 0; text-align: center; border-bottom-right-radius: 15px; border-bottom-left-radius: 15px;">
                                ...
                                <div class="col-4 col-md-3 col-lg-2">
                                    ...
                                    <div class="product-single p-0 svh" style="background-image: url('{{asset("assets/frontend/img/p2.jpg")}}'); height: 220px; border-radius: 15px; background-size: cover; background-position: center;">
                                        <div class="product-title pt-2" style=" width: 100%; background-color: #23374D; opacity: 0.8; position: absolute; bottom: 0; text-align: center; border-bottom-right-radius: 15px; border-bottom-left-radius: 15px;">
