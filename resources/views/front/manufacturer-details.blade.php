...
<div style="z-index: 1000 !important;">
    ...
    <div class="popup-box chat-popup" id="qnimate"  style="z-index: 1000 !important;">
        <div class="popup-head"  style="z-index: 1000 !important;">
            <div class="popup-head-left pull-left"><img src="{{ asset('storage/manufacturer/'.$manufacturer->avatar) }}" alt="iamgurdeeposahan"> {{ $manufacturer->company_name}}</div>
...
@section('page_js')
    <script>
        ...
        function continue_chat(){
            ...
            form.append("manufacturer_id", '{{ $manufacturer->id }}');
