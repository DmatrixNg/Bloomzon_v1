				...
				<div class="col-lg-6 offset-3 text-center">
					...
					<div class="product-single">
						<div class="contact-form mt-sm-30">
							...
							<form method="post" action="{{ url('/buyer/login') }}" data-toggle="validator">
                @csrf
								<div class="row">
									...
									<hr>
									<div class="col-sm-12 text-center pt-30">Don't have an account yet? <a href="{{ url('buyer/register') }}">Create account</a></div>
									<div class="col-sm-12 text-center pt-30">Forgot your Login Email or password? <a href="{{route('buyer.password.request')}}">
