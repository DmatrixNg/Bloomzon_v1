            ...
            <div class="row">
                <div class="col-lg-6 offset-3 text-center">
                    ...
                    <div class="product-single p-0 row">
                        <form class="contact-form mt-sm-30 col-md-12" method="POST" action="{{ url('buyer/register') }}">
                        @csrf
                            ...
                            <div id="contactForm">
                                <div class="row text-left">
                                    ...
                                    <div class="col-sm-12 form-group">
                                        ...
                                        <input id="password_confirmation" type="password" class="form-control @error('password_confirmation') is-invalid @enderror" name="password_confirmation" value="{{ old('password_confirmation') }}" autocomplete="password_confirmation" autofocus placeholder="Confirm Password">
                                    ...
                                    <div class="col-sm-12 text-center pt-30">
                                        Have an account yet? 
                                        <a href="{{ url('buyer/login') }}">Login</a>
                                        <br>
                                        <br>
                                    </div>
