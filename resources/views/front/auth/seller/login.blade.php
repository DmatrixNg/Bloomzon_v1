						...
						<div class="contact-form mt-sm-30">
							...
							<form action="{{ url('seller/login') }}" method="POST">
								...
								<div class="row">
									...
									<hr>
									<div class="col-sm-12 text-center pt-30">Don't have an account yet? <a href="{{ url('seller/register') }}">Create account</a></div>
									<div class="col-sm-12 text-center pt-30">Forgot your Login Email or password? <a href="{{route('seller.password.request')}}">
